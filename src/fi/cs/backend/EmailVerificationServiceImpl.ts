  ...
  implements Disposable, EmailVerificationService
{
  ...
  public static create(
    ...
    return new EmailVerificationServiceImpl(verificationTimeout);
  }

  public destroy() {
    forEach(this._codes, (item: InternalEmailCode) => {
      try {
  ...
  public removeVerificationCode(email: string, code: string) {
  ...
  public createVerificationCode(email: string): string {
