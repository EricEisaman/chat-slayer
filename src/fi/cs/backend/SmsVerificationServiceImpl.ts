  ...
  implements Disposable, SmsVerificationService
{
  ...
  public static create(
    ...
    return new SmsVerificationServiceImpl(verificationTimeout);
  }

  public destroy() {
    forEach(this._codes, (item: InternalSmsCode) => {
      try {
  ...
  public verifyCode(sms: string, code: string): boolean {
  ...
  public removeVerificationCode(sms: string, code: string) {
  ...
  public createVerificationCode(sms: string): string {
