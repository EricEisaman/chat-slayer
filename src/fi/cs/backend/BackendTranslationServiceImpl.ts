...
export class BackendTranslationServiceImpl implements TranslationService {
  ...
  public static async translateKeys(
    ...
    return TranslationUtils.translateKeys(
  ...
  public async initialize(
    ...
    return await BackendTranslationServiceImpl.initialize(
      defaultLanguage,
      resources,
    );
  }
  ...
  public async translateKeys(
    lang: Language,
    keys: string[],
    translationParams: ReadonlyJsonObject,
  ): Promise<TranslatedObject> {
    return await BackendTranslationServiceImpl.translateKeys(
      lang,
      keys,
      translationParams,
    );
