...
export class RequestClientImpl implements RequestClient {
  ...
  public async getTextEntity(
    ...
    return await this._adapter.textEntityRequest(
      RequestMethod.GET,
      url,
      headers,
    );
  ...
  public async postText(
    ...
    LOG.debug('.postJson: ', url, data, headers);
    return await this._adapter.textRequest(
      RequestMethod.POST,
      url,
      headers,
      data,
  ...
  public async postJson(
    ...
    return await this._adapter.jsonRequest(
      RequestMethod.POST,
      url,
      headers,
      data,
  ...
  public async getJsonEntity(
    ...
    return await this._adapter.jsonEntityRequest(
      RequestMethod.GET,
      url,
      headers,
    );
  ...
  public static setClient(client: RequestClientAdapter) {
  ...
  private static _createClientError() {
    return new TypeError(
      'RequestClient: You must initialize implementation first using CsFrontend.initialize() or CsNode.initialize()',
    );
  }
}
