import {
  explainWpUserProfileListDTO,
  isWpUserProfileListDTO,
} from './WpUserProfileListDTO';
...
const TEST_PROFILES = [
  ...
  },
  {
    ...
    title: 'fi-Jarmo Hoo',
    content:
      'Moi, onko t\u00e4m\u00e4 teko\u00e4lyn tuottamaa teksti\u00e4? Lorem Ipsumia jnejnejne',
    description: [
      'Intohimoinen visual designer.  Innokas valokuvaaja ja amat\u00f6\u00f6rimuusikko.  Seuraan suunnittelutrendej\u00e4, kuin haukka. \u00c4skett\u00e4in sukellettu teko\u00e4lytaiteen ihmeelliseen maailmaan.\r\n\r\nAdobe &amp; Affinity',
    ],
    'extra Information': [],
    slug: 'fi-130-jarmo-h',
    status: 'publish',
    featured_image: {
      thumbnail:
        'https:\/\/cms.example.com\/wp-content\/uploads\/2023\/01\/knight-rider-david-hasselhoff-1-150x150.jpg',
      medium:
        'https:\/\/cms.example.com\/wp-content\/uploads\/2023\/01\/knight-rider-david-hasselhoff-1-300x300.jpg',
      large:
        'https:\/\/cms.example.com\/wp-content\/uploads\/2023\/01\/knight-rider-david-hasselhoff-1.jpg',
    },
  },
  {
    id: 142,
    ...
    content: '',
    description: [
      'facebook: "https:\/\/www.facebook.com\/people\/Example-Company\/100084715241503\/",  linkedin:"https:\/\/www.linkedin.com\/company\/example-co\/"',
    ],
    'extra Information': [
      "Taija is solving customers' problems with modern web applications \u2014 ReactJS, HTML5, TypeScript, and NodeJS.",
    ],
    slug: 'fi-140-taija-l',
    status: 'publish',
  ...
  },
  {
    ...
    title: 'fi-Paul H',
    content:
      '<h2>Heip\u00e4 hei!<\/h2>\r\nNykyisin k\u00e4yt\u00f6ss\u00e4 olevia ohjelmointikieli\u00e4:\r\n<ul>\r\n \t<li>TypeScript, React<\/li>\r\n \t<li>C\/C++<\/li>\r\n \t<li>JavaScript<\/li>\r\n \t<li>PHP<\/li>\r\n<\/ul>\r\nAiemmin tutuksi tulleita kieli\u00e4:\r\n<ul>\r\n \t<li>Nasal - FlightGear-lentosimulaattorin ohjelmointikieli<\/li>\r\n \t<li>Assembly (x86, PIC)<\/li>\r\n \t<li>Turbo Pascal, Free Pascal<\/li>\r\n \t<li>Logo - Kukapa ei tykk\u00e4isi kilpikonnista ;)<\/li>\r\n \t<li>BASIC (Commodore64, GW-Basic, ST Basic, STOS,...)<\/li>\r\n<\/ul>\r\n<div class="contact-container">\r\n<div class="contact-email-content">\r\n<div class="contact-email-logo contact-logo"><a href="mailto:paul.hameenkorpi@.fi"><img class="alignnone size-full wp-image-330" src="https:\/\/cms.example.com\/wp-content\/uploads\/2023\/02\/mail_pyorea.png" alt="Email" width="90" height="90" \/><\/a><\/div>\r\n<div class="contact-email-address contact-text"><a href="mailto:paul.hameenkorpi@.fi">paul.hameenkorpi@.fi<\/a><\/div>\r\n<\/div>\r\n<div class="contact-phone-content">\r\n<div class="contact-phone-logo contact-logo"><a href="tel:+358505410858"><img class="alignnone size-full wp-image-331" src="https:\/\/cms.example.com\/wp-content\/uploads\/2023\/02\/phone_pyorea.png" alt="Phone" width="90" height="90" \/><\/a><\/div>\r\n<div class="contact-phone-number contact-text"><a href="tel:+358505410858">050-5410858<\/a><\/div>\r\n<\/div>\r\n<\/div>',
    description: [''],
    'extra Information': [],
    slug: 'fi-150-paul-h',
    status: 'publish',
  ...
  },
  {
    ...
    title: 'fi-Jaakko-Heikki H',
    content: '',
    description: [''],
    'extra Information': [],
    slug: 'fi-100-jaakko-heikki-h',
    status: 'publish',
    featured_image: {thumbnail: false, medium: false, large: false},
  },
  {
