...
export function explainWpPageListDTO(value: unknown): string {
  return explainArrayOf<WpPageDTO>(
    'WpPageDTO',
    explainWpPageDTO,
    value,
    isWpPageDTO,
...
export function parseWpPagesDTO(value: unknown): WpPageListDTO | undefined {
