  ...
  public static getValue(value: number, type: SiType): number {
    switch (type) {
      case SiType.NONE:
        return value;
      case SiType.KILO:
        return value / KILO_IN_BINARY;
      case SiType.MEGA:
        return value / MEGA_IN_BINARY;
      case SiType.GIGA:
        return value / GIGA_IN_BINARY;
      case SiType.TERA:
        return value / TERA_IN_BINARY;
      case SiType.PETA:
        return value / PETA_IN_BINARY;
      case SiType.EXA:
        return value / EXA_IN_BINARY;
      case SiType.ZETTA:
        return value / ZETTA_IN_BINARY;
      case SiType.YOTTA:
        return value / YOTTA_IN_BINARY;
      default:
        throw new TypeError(`SiType not implemented: ${type}`);
    }
  }
  ...
  public static getBytes(value: number, type: SiType): number {
    switch (type) {
      ...
      case SiType.YOTTA:
        return value * YOTTA_IN_BINARY;
      default:
        throw new TypeError('Undefined si type: ' + type);
    }
  }
}
