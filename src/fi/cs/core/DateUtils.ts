...
export class DateUtils {
   ...
   */
  public static subtractDays(date: Date, offset: number): Date {
   ...
   */
  public static getFirstDayOfMonth(startDate: Date, offset: number = 0): Date {
   ...
   */
  public static getLastDayOfMonth(startDate: Date, offset: number = 0): Date {
