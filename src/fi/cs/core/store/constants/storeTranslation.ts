...
export function getProductFeatureCategoryTitleTranslationToken(
  categoryId: ProductFeatureCategory,
) {
  return `productFeatureCategory.${categoryId}`;
}

export function getProductFeatureTitleTranslationToken(
...
export function getSelectPriceTypeTextForPriceType(
...
export function getInventoryStateTranslationKey(
...
export function getNetworkTypeFeatureTranslation(
  networkType: NetworkType,
): string {
  return `networkType.${networkType}`;
}

export function getNetworkZoneFeatureTranslation(
  networkZone: NetworkZone,
): string {
  return `networkZone.${networkZone}`;
}

export function getNetworkIpTypeFeatureTranslation(
  networkIpType: NetworkIpType,
): string {
  return `networkIpType.${networkIpType}`;
}

export function getVirtualizationTypeFeatureTranslation(
  value: VirtualizationType,
): string {
  return `virtualizationType.${value}`;
}

export function getOperatingSystemFeatureTranslation(
