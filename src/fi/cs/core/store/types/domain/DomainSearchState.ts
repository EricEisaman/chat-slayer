...
export function isDomainSearchState(
  value: unknown,
): value is DomainSearchState {
  switch (value) {
...
export function explainDomainSearchState(value: unknown): string {
  return explainEnum(
    'DomainSearchState',
    DomainSearchState,
    isDomainSearchState,
...
export function parseDomainSearchState(
  value: unknown,
): DomainSearchState | undefined {
  if (value === undefined) return undefined;
  switch (`${value}`.toUpperCase()) {
    case 'SEARCHING':
      return DomainSearchState.SEARCHING;
    case 'TRANSFERABLE':
      return DomainSearchState.TRANSFERABLE;
    case 'UNAVAILABLE':
      return DomainSearchState.UNAVAILABLE;
    case 'AVAILABLE':
      return DomainSearchState.AVAILABLE;
    default:
      return undefined;
  }
}
