...
export function isStoreCategoryType(
  value: unknown,
): value is StoreCategoryType {
  switch (value) {
...
export function parseStoreCategoryType(value: unknown): StoreCategoryType {
  switch (`${value}`.toUpperCase()) {
    case 'EMAIL':
      return StoreCategoryType.HOSTING;
    case 'SHELL':
      return StoreCategoryType.HOSTING;
    case 'WEBHOTEL':
      return StoreCategoryType.HOSTING;
    ...
    case 'HOSTING':
      return StoreCategoryType.HOSTING;
    case 'SHORTDOMAINS':
      return StoreCategoryType.DOMAINS;
    case 'SHORT_DOMAINS':
      return StoreCategoryType.DOMAINS;
    case 'DOMAINS':
      return StoreCategoryType.DOMAINS;
    case 'COMPUTERS':
      return StoreCategoryType.USED_COMPUTERS;
    case 'USED_COMPUTERS':
      return StoreCategoryType.USED_COMPUTERS;
    case 'USEDCOMPUTERS':
      return StoreCategoryType.USED_COMPUTERS;
    case 'NETWORK':
      return StoreCategoryType.NETWORK;
    case 'OTHER':
      return StoreCategoryType.OTHER;
    default:
      return StoreCategoryType.OTHER;
  }
}
