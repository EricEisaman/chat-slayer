...
export function explainProductPriceType(value: unknown): string {
  return explainEnum(
    'ProductPriceType',
    ProductPriceType,
    isProductPriceType,
...
export function parseProductPriceType(
  value: unknown,
): ProductPriceType | undefined {
  switch (`${value}`.toUpperCase()) {
    case 'ONCE':
      return ProductPriceType.ONCE;
    case 'HOURLY':
      return ProductPriceType.HOURLY;
    case 'DAILY':
      return ProductPriceType.DAILY;
    case 'WEEKLY':
      return ProductPriceType.WEEKLY;
    case 'BIWEEKLY':
      return ProductPriceType.BIWEEKLY;
    case 'MONTHLY':
      return ProductPriceType.MONTHLY;
    case 'BIMONTHLY':
      return ProductPriceType.BIMONTHLY;
    case 'QUARTERLY':
      return ProductPriceType.QUARTERLY;
    case 'SEASONAL':
      return ProductPriceType.SEASONAL;
    case 'BIANNUAL':
      return ProductPriceType.BIANNUAL;
    case 'YEARLY':
      return ProductPriceType.YEARLY;
    case 'YEARS_2':
      return ProductPriceType.YEARS_2;
    case 'YEARS_3':
      return ProductPriceType.YEARS_3;
    case 'YEARS_4':
      return ProductPriceType.YEARS_4;
    case 'YEARS_5':
      return ProductPriceType.YEARS_5;
    case 'YEARS_10':
      return ProductPriceType.YEARS_10;
    default:
      return undefined;
  }
}
 ...
 * @param priceType
 */
export function getBillingMonthsForProductPriceType(
...
export function isProductPriceTypeOrUndefined(
  value: unknown,
): value is ProductPriceType | undefined {
  return isUndefined(value) || isProductPriceType(value);
}

export function explainProductPriceTypeOrUndefined(value: unknown): string {
  return isProductPriceTypeOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['ProductPriceType', 'undefined']));
}
