...
export function isProductTableModel(
  value: unknown,
): value is ProductTableModel {
  return (
    isRegularObject(value) &&
    hasNoOtherKeys(value, ['id', 'title', 'description', 'month', 'price'])
  );
}

export function isPartialProductTableModel(
  value: unknown,
): value is Partial<ProductTableModel> {
  return (
    isRegularObject(value) &&
    hasNoOtherKeys(value, ['id', 'title', 'description', 'month', 'price'])
  );
...
export function parseProductTableModel(
  value: unknown,
): ProductTableModel | undefined {
