...
export function stringifyProductType(value: ProductType): string {
  switch (value) {
    ...
    case ProductType.VIRTUAL_SERVER_EXTRA:
      return 'VIRTUAL_SERVER_EXTRA';
    case ProductType.WEB_HOTEL_EXTRA:
      return 'WEB_HOTEL_EXTRA';
    case ProductType.EMAIL_EXTRA:
      return 'EMAIL_EXTRA';
    case ProductType.SHELL_EXTRA:
      return 'SHELL_EXTRA';
...
export function parseProductType(value: unknown): ProductType | undefined {
  switch (value) {
    ...
    case 'PREMIUM_DOMAIN':
      return ProductType.PREMIUM_DOMAIN;
    case 'VIRTUAL_SERVER':
      return ProductType.VIRTUAL_SERVER;
    case 'VIRTUAL_SERVER_EXTRA':
      return ProductType.VIRTUAL_SERVER_EXTRA;
    case 'WEB_HOTEL_EXTRA':
      return ProductType.WEB_HOTEL_EXTRA;
    case 'EMAIL_EXTRA':
      return ProductType.EMAIL_EXTRA;
    case 'SHELL_EXTRA':
      return ProductType.SHELL_EXTRA;
    case 'WEB_HOTEL':
      return ProductType.WEB_HOTEL;
    case 'DOMAIN':
      return ProductType.DOMAIN;
    case 'DOMAIN_TRANSFER':
      return ProductType.DOMAIN_TRANSFER;
    case 'EMAIL':
      return ProductType.EMAIL;
    case 'SHELL':
      return ProductType.SHELL;
    case 'DATABASE':
      return ProductType.DATABASE;
    case 'WP':
      return ProductType.WP;
    case 'NET':
      return ProductType.NET;
    case 'WEBRTC':
      return ProductType.WEBRTC;
    case 'STOCK':
...
export function isProductTypeOrUndefined(
  value: unknown,
): value is ProductType | undefined {
  return isUndefined(value) || isProductType(value);
}

export function explainProductTypeOrUndefined(value: unknown): string {
  return isProductTypeOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['ProductType', 'undefined']));
}
