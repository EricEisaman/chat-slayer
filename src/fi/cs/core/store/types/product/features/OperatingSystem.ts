...
export function explainOperatingSystem(value: unknown): string {
  return explainEnum(
    'OperatingSystem',
    OperatingSystem,
    isOperatingSystem,
...
export function stringifyOperatingSystem(value: OperatingSystem): string {
  switch (value) {
    case OperatingSystem.LINUX_UBUNTU_LTS_20_04:
      return 'LINUX_UBUNTU_LTS_20_04';
    case OperatingSystem.LINUX_UBUNTU_LTS_22_04:
      return 'LINUX_UBUNTU_LTS_22_04';
    case OperatingSystem.LINUX_UBUNTU_LTS_18_04:
      return 'LINUX_UBUNTU_LTS_18_04';
    case OperatingSystem.LINUX_DEBIAN_10:
      return 'LINUX_DEBIAN_10';
    case OperatingSystem.LINUX_ARCH:
      return 'LINUX_ARCH';
    case OperatingSystem.LINUX_NIXOS:
      return 'LINUX_NIXOS';
...
export function parseOperatingSystem(
  ...
  switch (`${value}`.toUpperCase()) {
    ...
    case 'LINUX_UBUNTU_LTS_22_04':
      return OperatingSystem.LINUX_UBUNTU_LTS_22_04;

    case 'LINUX_UBUNTU_LTS_20_04':
      return OperatingSystem.LINUX_UBUNTU_LTS_20_04;
    case 'LINUX_UBUNTU_LTS_18_04':
      return OperatingSystem.LINUX_UBUNTU_LTS_18_04;

    case 'LINUX_DEBIAN_10':
      return OperatingSystem.LINUX_DEBIAN_10;
    case 'LINUX_ARCH':
      return OperatingSystem.LINUX_ARCH;
    case 'LINUX_NIXOS':
      return OperatingSystem.LINUX_NIXOS;
    case 'FREEBSD':
      return OperatingSystem.FREEBSD;
    case 'LINUX_FREEBSD':
      return OperatingSystem.LINUX_FREEBSD;
