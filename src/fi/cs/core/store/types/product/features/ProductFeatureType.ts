...
export function isProductFeatureType(
  value: unknown,
): value is ProductFeatureType {
  switch (value) {
...
export function parseProductFeatureType(
  value: unknown,
): ProductFeatureType | undefined {
  switch (`${value}`.toUpperCase()) {
    case 'OTHER':
      return ProductFeatureType.OTHER;
    case 'SHELL':
      return ProductFeatureType.SHELL;
    case 'EMAIL':
      return ProductFeatureType.EMAIL;
    ...
    case 'SERVER':
      return ProductFeatureType.SERVER;
    case 'CABLE':
      return ProductFeatureType.CABLE;
    case 'DOMAIN':
      return ProductFeatureType.DOMAIN;
