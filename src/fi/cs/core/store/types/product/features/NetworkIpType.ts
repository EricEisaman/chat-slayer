...
export function isNetworkIpType(value: unknown): value is NetworkIpType {
  switch (value) {
...
export function explainNetworkIpType(value: unknown): string {
...
export function parseNetworkIpType(value: unknown): NetworkIpType | undefined {
  if (value === undefined) return undefined;
  switch (`${value}`.toUpperCase()) {
    case 'PUBLIC_INCLUDED':
      return NetworkIpType.PUBLIC_INCLUDED;
    case 'PUBLIC_AVAILABLE':
      return NetworkIpType.PUBLIC_AVAILABLE;
    case 'PRIVATE_NAT':
