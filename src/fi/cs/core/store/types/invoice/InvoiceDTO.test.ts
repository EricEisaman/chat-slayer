...
describe('InvoiceDTO', () => {
  ...
  it('explainInvoiceDTO should explain invalid InvoiceDTO', () => {
    ...
    expect(explainInvoiceDTO(invalidDTO)).toContain(
      'property "clientId" not string',
    );
  });
  ...
  it('explainInvoiceDTOOrUndefined should explain invalid InvoiceDTO', () => {
    ...
    expect(explainInvoiceDTOOrUndefined(invalidDTO)).toContain(
      'not InvoiceDTO | undefined',
    );
  });
