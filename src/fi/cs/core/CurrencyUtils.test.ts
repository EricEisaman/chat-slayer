...
describe('CurrencyUtils', () => {
  ...
  describe('convertCurrencyAmount', () => {
    it('converts a currency amount from one currency to another', () => {
      expect(
        CurrencyUtils.convertCurrencyAmount(
          validRates,
          100,
          Currency.EUR,
          Currency.USD,
    ...
    it('throws an error when to-currency is invalid', () => {
      ...
      ).toThrow('CurrencyService: To: No exchange rate found: INVALID');
    });
    ...
    it('throws an error when from-currency is invalid', () => {
      ...
      ).toThrow('CurrencyService: From: No exchange rate found: INVALID');
    });
  });
