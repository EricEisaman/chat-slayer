...
//     Body: "This is a message body"
// };
const mockTwilioCreateMessageBody =
  'To=%2B123456789&From=%2B987654321&Body=This+is+a+message+body';
...
describe('TwilioMessageClientImpl', () => {
  ...
  describe('sendSms', () => {
    ...
    it('should throw an error when the response is not TwilioMessageDTO', async () => {
      ...
      await expect(
        twilioClient.sendSms(mockMessageBody, mockRecipient, mockSender),
