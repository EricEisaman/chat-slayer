...
import {
  createTwilioCreateMessageDTO,
  explainTwilioCreateMessageDTO,
  explainTwilioCreateMessageDTOOrUndefined,
  isTwilioCreateMessageDTO,
  isTwilioCreateMessageDTOOrUndefined,
  parseTwilioCreateMessageDTO,
} from './TwilioCreateMessageDTO';
...
describe('TwilioCreateMessageDTO', () => {
  describe('createTwilioCreateMessageDTO', () => {
    it('returns the correct DTO', () => {
      expect(
        createTwilioCreateMessageDTO(mockRecipient, mockSender, mockMediaUrl),
      ).toEqual(mockTwilioCreateMessageDTO);
    });
  });
  ...
  describe('explainTwilioCreateMessageDTO', () => {
    it('returns a correct explanation for valid and invalid DTOs', () => {
      ...
      expect(explainTwilioCreateMessageDTO(mockInvalid)).toEqual(
  ...
  describe('parseTwilioCreateMessageDTO', () => {
    it('returns the DTO for valid DTOs and undefined for invalid values', () => {
      ...
      ).toEqual({...mockRecipient, ...mockSender, ...mockMediaUrl});
  ...
  describe('explainTwilioCreateMessageDTOOrUndefined', () => {
    ...
    it('returns a correct explanation for undefined', () => {
      expect(explainTwilioCreateMessageDTOOrUndefined(mockUndefined)).toEqual(
        explainOk(),
      );
    });

    it('returns a correct explanation for invalid values', () => {
      expect(explainTwilioCreateMessageDTOOrUndefined(mockInvalid)).toEqual(
