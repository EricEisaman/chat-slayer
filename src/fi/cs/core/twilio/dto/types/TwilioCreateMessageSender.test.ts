import {
  createTwilioCreateMessageSender,
  explainTwilioCreateMessageSender,
  explainTwilioCreateMessageSenderOrUndefined,
  isTwilioCreateMessageSender,
  isTwilioCreateMessageSenderOrUndefined,
  parseTwilioCreateMessageSender,
} from './TwilioCreateMessageSender';

const VALID_FROM = {From: '+15557122661'};
const VALID_MESSAGING_SERVICE_SID = {
...
describe('TwilioCreateMessageSender', () => {
  describe('createTwilioCreateMessageSender', () => {
    ...
    it('should create a valid object for MessagingServiceSid', () => {
      const result = createTwilioCreateMessageSender(
  ...
  describe('isTwilioCreateMessageSender', () => {
    ...
    it('should return true for valid MessagingServiceSid input', () => {
      expect(
        isTwilioCreateMessageSender(VALID_MESSAGING_SERVICE_SID),
      ).toBeTruthy();
    });
  ...
  describe('explainTwilioCreateMessageSender', () => {
    ...
    it('should return OK for valid MessagingServiceSid input', () => {
      expect(
        explainTwilioCreateMessageSender(VALID_MESSAGING_SERVICE_SID),
      ).toBe('OK');
    });
  ...
  describe('parseTwilioCreateMessageSender', () => {
    ...
    it('should return value for valid MessagingServiceSid input', () => {
      expect(
        parseTwilioCreateMessageSender(VALID_MESSAGING_SERVICE_SID),
      ).toEqual(VALID_MESSAGING_SERVICE_SID);
    });
  ...
  describe('isTwilioCreateMessageSenderOrUndefined', () => {
    ...
    it('should return true for valid MessagingServiceSid input', () => {
      expect(
        isTwilioCreateMessageSenderOrUndefined(VALID_MESSAGING_SERVICE_SID),
      ).toBeTruthy();
    });
    ...
    it('should return false for invalid non-undefined input', () => {
      expect(
        isTwilioCreateMessageSenderOrUndefined(INVALID_SENDER),
      ).toBeFalsy();
    });
  });
  ...
  describe('explainTwilioCreateMessageSenderOrUndefined', () => {
    it('should return OK for valid From input', () => {
      expect(explainTwilioCreateMessageSenderOrUndefined(VALID_FROM)).toBe(
        'OK',
      );
    });
    ...
    it('should return error string for invalid non-undefined input', () => {
      expect(
        explainTwilioCreateMessageSenderOrUndefined(INVALID_SENDER),
      ).not.toBe('OK');
    });
  });
});
