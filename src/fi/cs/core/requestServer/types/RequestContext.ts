...
import {
  ...
  WritableRequestQueryParameters,
} from '../../request/utils/RequestQueryParameters';
...
export function parseRequestContextFromPath(
  ...
  const queryParams: WritableRequestQueryParameters = {};
  forEach(params, (item: string): void => {
