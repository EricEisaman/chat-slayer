...
export class FetchRequestClient implements RequestClientAdapter {
    ...
    switch (method) {
      case RequestMethod.GET:
        return await this._jsonRequest(
          ...
          FetchRequestClient._successJsonResponse(response, RequestMethod.GET),
        );
      ...
      default:
        throw new TypeError(
          `FetchRequestClient: Unsupported method: ${method}`,
        );
    }
  }
    ...
    switch (method) {
      case RequestMethod.GET:
        return await this._textRequest(
          ...
          FetchRequestClient._successTextResponse(response, RequestMethod.GET),
        );
      case RequestMethod.POST:
        return await this._textRequest(
          RequestMethod.POST,
    ...
    switch (method) {
      case RequestMethod.GET:
        return await this._jsonRequest(
          ...
          FetchRequestClient._successJsonEntityResponse(
            response,
            RequestMethod.GET,
          ),
        );
    ...
    switch (method) {
      case RequestMethod.GET:
        return await this._textRequest(
          ...
          FetchRequestClient._successTextEntityResponse(
            response,
            RequestMethod.GET,
          ),
        );
  ...
  private static async _successJsonEntityResponse(
    ...
    return ResponseEntity.ok(body)
      .status(statusCode)
      .headers(FetchRequestClient._parseResponseHeaders(response));
  }
