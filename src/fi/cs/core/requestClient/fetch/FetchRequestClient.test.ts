...
describe('FetchRequestClient', () => {
  ...
  describe('#jsonRequest', () => {
    it('makes a GET JSON request with the given url and headers', async () => {
      const response = await fetchRequestClient.jsonRequest(
        RequestMethod.GET,
        'http://example.com',
        {},
      );
  ...
  describe('#textRequest', () => {
    it('makes a GET text request with the given url and headers', async () => {
      const response = await fetchRequestClient.textRequest(
        RequestMethod.GET,
        'http://example.com',
        {},
      );
  ...
  describe('#jsonEntityRequest', () => {
    it('makes a GET JSON request with the given url and headers', async () => {
      const response = await fetchRequestClient.jsonEntityRequest(
        RequestMethod.GET,
        'http://example.com',
        {},
      );
      ...
      expect(response.getHeaders().getFirst('Content-Type')).toStrictEqual(
        ContentType.JSON,
      );
  ...
  describe('#textEntityRequest', () => {
    it('makes a GET text request with the given url and headers', async () => {
      const response = await fetchRequestClient.textEntityRequest(
        RequestMethod.GET,
        'http://example.com',
        {},
      );
