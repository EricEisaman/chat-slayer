...
export class SmsQueueEntity extends Entity {
  ...
  public static toDTO(entity: SmsQueueEntity): SmsQueueDTO {
    if (entity.smsQueueId === undefined)
      throw new TypeError('entity.smsQueueId missing');
    if (entity.updated === undefined)
      throw new TypeError('entity.updated missing');
    if (entity.created === undefined)
      throw new TypeError('entity.created missing');
    if (entity.invoiceId === undefined)
      throw new TypeError('entity.invoiceId missing');
    if (entity.clientId === undefined)
      throw new TypeError('entity.clientId missing');
    if (entity.senderAddress === undefined)
      throw new TypeError('entity.senderAddress missing');
    if (entity.targetAddress === undefined)
      throw new TypeError('entity.targetAddress missing');
    if (entity.message === undefined)
      throw new TypeError('entity.message missing');
    if (entity.sent === undefined) throw new TypeError('entity.sent missing');
    if (entity.failed === undefined)
      throw new TypeError('entity.failed missing');
    if (entity.isTerminated === undefined)
      throw new TypeError('entity.isTerminated missing');
    ...
    if (!isSmsQueueDTO(dto)) {
      ...
      throw new TypeError(
        `Failed to create valid SmsQueueDTO: ${explainSmsQueueDTO(dto)}`,
      );
    }
    return dto;
  }
