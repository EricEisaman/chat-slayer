...
import {
  createVerifySmsCodeDTO,
  VerifySmsCodeDTO,
} from './auth/sms/types/VerifySmsCodeDTO';
import {ReadonlyJsonAny} from './Json';
import {
  CallbackWithLanguage,
  AUTHENTICATE_SMS_URL,
  VERIFY_SMS_CODE_URL,
  VERIFY_SMS_TOKEN_URL,
} from './auth/sms/sms-auth-constants';
import {LogLevel} from './types/LogLevel';
import {
  createVerifySmsTokenDTO,
  VerifySmsTokenDTO,
} from './auth/sms/types/VerifySmsTokenDTO';
...
export class SmsAuthHttpService {
  private static _authenticateSmsUrl: CallbackWithLanguage =
    AUTHENTICATE_SMS_URL;
  private static _verifySmsCodeUrl: CallbackWithLanguage = VERIFY_SMS_CODE_URL;
  private static _verifySmsTokenUrl: CallbackWithLanguage =
    VERIFY_SMS_TOKEN_URL;
