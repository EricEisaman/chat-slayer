...
import {
  createShoppingCart,
  ShoppingCart,
} from './store/types/cart/ShoppingCart';
...
export class StoreCartService {
  private static _observer: Observer<StoreCartServiceEvent> =
    new Observer<StoreCartServiceEvent>('StoreCartService');
  ...
  public static addProduct(
    ...
    this._cart = ShoppingCartUtils.addItemToCart(
      this._cart,
      product,
      price,
      amount,
  ...
  public static removeProduct(
    ...
    this._cart = ShoppingCartUtils.removeItemFromCart(
      this._cart,
      product,
      price,
      amount,
  ...
  public static toggleCartMenu() {
    StoreCartService.setCartMenuOpen(!StoreCartService.isCartMenuOpen());
  }
