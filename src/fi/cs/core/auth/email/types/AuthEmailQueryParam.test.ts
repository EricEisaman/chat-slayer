import {
  AuthEmailQueryParam,
  isAuthEmailQueryParam,
  parseAuthEmailQueryParam,
  stringifyAuthEmailQueryParam,
} from './AuthEmailQueryParam';
...
describe('AuthEmailQueryParam', () => {
  ...
  describe('stringifyAuthEmailQueryParam', () => {
    ...
    it('should throw TypeError for unsupported AuthEmailQueryParam values', () => {
      // @ts-ignore
      expect(() => stringifyAuthEmailQueryParam('invalidValue')).toThrowError(
        TypeError,
      );
    });
  });
