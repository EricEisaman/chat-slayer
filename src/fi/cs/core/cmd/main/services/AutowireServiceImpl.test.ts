  ...
  describe('with already setup service', () => {
    ...
    describe('getName', () => {
      ...
      it('throws error when getting a non-existant name', () => {
        expect(() => autowireService.getName('nonExistant')).toThrowError(
          'Autowire service did not have name: nonExistant',
        );
      });
    });
    ...
    describe('getAutowireService', () => {
      it('returns the current autowire service', () => {
        expect(AutowireServiceImpl.getAutowireService()).toEqual(
          autowireService,
        );
      });
    });
  ...
  describe('with uninitialized service', () => {
    ...
    describe('getAutowireService', () => {
      it('throws error when no autowire service has been set', () => {
        expect(() => AutowireServiceImpl.getAutowireService()).toThrowError(
          'Autowire service has not been initialized',
        );
      });
    });
  });
