...
export class DestroyServiceImpl implements DestroyService {
   ...
   * @inheritDoc
   */
  public addDestroyListener(callback: VoidCallback): DestroyServiceDestructor {
   ...
   * @inheritDoc
   */
  public registerDisposable(obj: Disposable): DestroyServiceDestructor {
    return this.addDestroyListener(() => obj.destroy());
  }
}
