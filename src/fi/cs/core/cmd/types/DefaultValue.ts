...
export class DefaultValue {
   ...
   * @param impl
   */
  public static initialize(impl: DefaultValueCallbackFactory): void {
    this._impl = impl;
  }
  ...
  public static fromAutowired(name: string): DefaultValueCallback {
    if (!this._impl)
      throw new TypeError('DefaultValue.fromAutowired() not initialized');
  ...
  public static fromTextFile(): DefaultValueCallback {
    if (!this._impl)
      throw new TypeError('DefaultValue.fromTextFile() not initialized');
  ...
  public static fromChain(
    ...
    if (!this._impl)
      throw new TypeError('DefaultValue.fromChain() not initialized');
