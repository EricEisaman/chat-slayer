...
import {
  ...
  VerifyEmailCodeDTO,
} from './auth/email/types/VerifyEmailCodeDTO';
import {ReadonlyJsonAny} from './Json';
import {
  CallbackWithLanguage,
  AUTHENTICATE_EMAIL_URL,
  VERIFY_EMAIL_CODE_URL,
  VERIFY_EMAIL_TOKEN_URL,
} from './auth/email/email-auth-constants';
import {LogLevel} from './types/LogLevel';
import {
  createVerifyEmailTokenDTO,
  VerifyEmailTokenDTO,
} from './auth/email/types/VerifyEmailTokenDTO';
...
export class EmailAuthHttpService {
  private static _authenticateEmailUrl: CallbackWithLanguage =
    AUTHENTICATE_EMAIL_URL;
  private static _verifyEmailCodeUrl: CallbackWithLanguage =
    VERIFY_EMAIL_CODE_URL;
  private static _verifyEmailTokenUrl: CallbackWithLanguage =
    VERIFY_EMAIL_TOKEN_URL;
