...
export function isPaytrailPaymentProviderListDTO(
  value: unknown,
): value is PaytrailPaymentProviderListDTO {
  return (
    isRegularObject(value) &&
    hasNoOtherKeysInDevelopment(value, ['terms', 'groups', 'providers']) &&
...
export function explainPaytrailPaymentProviderListDTO(value: unknown): string {
  return explain([
    explainRegularObject(value),
    explainNoOtherKeysInDevelopment(value, ['terms', 'groups', 'providers']),
...
export function parsePaytrailPaymentProviderListDTO(
  value: unknown,
): PaytrailPaymentProviderListDTO | undefined {
  if (isPaytrailPaymentProviderListDTO(value)) return value;
  return undefined;
}

export function isPaytrailPaymentProviderListDTOOrUndefined(
  value: unknown,
): value is PaytrailPaymentProviderListDTO | undefined {
  return isUndefined(value) || isPaytrailPaymentProviderListDTO(value);
}

export function explainPaytrailPaymentProviderListDTOOrUndefined(
  value: unknown,
): string {
  return isPaytrailPaymentProviderListDTOOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['PaytrailPaymentProviderListDTO', 'undefined']));
}
