import {
  createPaytrailPaymentProviderListDTO,
  explainPaytrailPaymentProviderListDTO,
  isPaytrailPaymentProviderListDTO,
  parsePaytrailPaymentProviderListDTO,
  PaytrailPaymentProviderListDTO,
} from './PaytrailPaymentProviderListDTO';
...
describe('PaytrailPaymentProviderListDTO', () => {
  ...
  describe('isPaytrailPaymentProviderListDTO', () => {
    ...
    it('returns false if the object is not PaytrailPaymentProviderListDTO', () => {
      const result = isPaytrailPaymentProviderListDTO({
        ...mockedPaymentDTO,
        amount: 'invalid',
      }); // invalid amount property
  ...
  describe('explainPaytrailPaymentProviderListDTO', () => {
    it('explains why an object cannot be parsed into PaytrailPaymentProviderListDTO', () => {
      const result = explainPaytrailPaymentProviderListDTO({
        ...mockedPaymentDTO,
        amount: 'invalid',
      }); // invalid amount property
  ...
  describe('parsePaytrailPaymentProviderListDTO', () => {
    ...
    it('returns undefined if the object cannot be parsed into PaytrailPaymentProviderListDTO', () => {
      const result = parsePaytrailPaymentProviderListDTO({
        ...mockedPaymentDTO,
        amount: 'invalid',
      }); // invalid amount property
