import {
  createPaytrailCreatePaymentDTO,
  ...
  parsePaytrailCreatePaymentDTO,
} from './PaytrailCreatePaymentDTO';
...
describe('PaytrailCreatePaymentDTO', () => {
  ...
  describe('explainPaytrailCreatePaymentDTO', () => {
    it('explains why an object cannot be parsed into PaytrailCreatePaymentDTO', () => {
      ...
      expect(result).toContain(
        'property "groups" not PaytrailPaymentMethodGroupData',
      );
      ...
      expect(result).not.toContain(
        'property "customProviders" not ReadonlyJsonObject',
      );
    });
  });
  ...
  describe('isPaytrailCreatePaymentDTOOrUndefined', () => {
    it('validates if a value is PaytrailCreatePaymentDTO or undefined', () => {
      expect(
        isPaytrailCreatePaymentDTOOrUndefined(mockedPaytrailCreatePaymentDTO),
      ).toBe(true);
