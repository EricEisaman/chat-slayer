import {
  ...
  explainPaytrailPaymentMethodGroupOrUndefined,
  isPaytrailPaymentMethodGroup,
  isPaytrailPaymentMethodGroupOrUndefined,
  parsePaytrailPaymentMethodGroup,
  PaytrailPaymentMethodGroup,
  stringifyPaytrailPaymentMethodGroup,
...
describe('PaytrailPaymentMethodGroup', () => {
  ...
  const validGroupTexts = ['MOBILE', 'BANK', 'CREDIT_CARD', 'CREDIT'];
  ...
  describe('explainPaytrailPaymentMethodGroup', () => {
    ...
    it('should return an explanation for invalid group', () => {
      expect(explainPaytrailPaymentMethodGroup(invalidGroup)).toContain(
        'incorrect enum value "cash" for PaytrailPaymentMethodGroup: Accepted values mobile, bank, creditcard, credit',
      );
    });
  });
  ...
  describe('stringifyPaytrailPaymentMethodGroup', () => {
    validGroups.forEach((group, index) => {
      it(`should correctly stringify "${group}"`, () => {
        expect(stringifyPaytrailPaymentMethodGroup(group)).toEqual(
          validGroupTexts[index],
        );
      });
    });
  });
  ...
  describe('explainPaytrailPaymentMethodGroupOrUndefined', () => {
    it('should return OK for undefined', () => {
      expect(explainPaytrailPaymentMethodGroupOrUndefined(undefined)).toEqual(
        'OK',
      );
    });
    ...
    validGroups.forEach(group => {
      it(`should return OK for "${group}"`, () => {
        expect(explainPaytrailPaymentMethodGroupOrUndefined(group)).toEqual(
          'OK',
        );
      });
    });
    ...
    it('should return an explanation for invalid group', () => {
      expect(
        explainPaytrailPaymentMethodGroupOrUndefined(invalidGroup),
      ).toContain('not PaytrailPaymentMethodGroup or undefined');
    });
  });
});
