import {
  ...
  explainPaytrailLanguageOrUndefined,
  isPaytrailLanguage,
  isPaytrailLanguageOrUndefined,
  parsePaytrailLanguage,
  PaytrailLanguage,
  stringifyPaytrailLanguage,
} from './PaytrailLanguage';
...
describe('PaytrailLanguage', () => {
  ...
  describe('explainPaytrailLanguage', () => {
    ...
    it('should return an explanation for invalid language', () => {
      expect(explainPaytrailLanguage(invalidLanguage)).toContain(
        'incorrect enum value "ES" for PaytrailLanguage: Accepted values FI, SV, EN',
      );
    });
  });
  ...
  describe('explainPaytrailLanguageOrUndefined', () => {
    ...
    it('should return an explanation for invalid language', () => {
      expect(explainPaytrailLanguageOrUndefined(invalidLanguage)).toContain(
        'not PaytrailLanguage or undefined',
      );
    });
  });
});
