...
export function isPaytrailPaymentMethodGroupData(
  value: unknown,
): value is PaytrailPaymentMethodGroupData {
  return (
...
export function explainPaytrailPaymentMethodGroupData(value: unknown): string {
  return explain([
    ...
    explainProperty(
      'id',
      explainPaytrailPaymentMethodGroup(objectKey(value, 'id')),
    ),
    ...
    explainProperty(
      'providers',
      explainArrayOfOrUndefined<PaytrailProvider>(
        'PaytrailProvider',
        explainPaytrailProvider,
        objectKey(value, 'providers'),
        isPaytrailProvider,
...
export function parsePaytrailPaymentMethodGroupData(
  value: unknown,
): PaytrailPaymentMethodGroupData | undefined {
  if (isPaytrailPaymentMethodGroupData(value)) return value;
  return undefined;
}

export function isPaytrailPaymentMethodGroupDataOrUndefined(
  value: unknown,
): value is PaytrailPaymentMethodGroupData | undefined {
  return isUndefined(value) || isPaytrailPaymentMethodGroupData(value);
}

export function explainPaytrailPaymentMethodGroupDataOrUndefined(
  value: unknown,
): string {
  return isPaytrailPaymentMethodGroupDataOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['PaytrailPaymentMethodGroupData', 'undefined']));
}
