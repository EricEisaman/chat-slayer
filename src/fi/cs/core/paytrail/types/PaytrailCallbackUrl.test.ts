import {
  ...
  parsePaytrailCallbackUrl,
} from './PaytrailCallbackUrl';
...
describe('PaytrailCallbackUrl', () => {
  ...
  describe('isPaytrailCallbackUrl', () => {
    ...
    it('should return false for invalid objects', () => {
      expect(
        isPaytrailCallbackUrl({...validCallbackUrl, unknownProperty: 'Test'}),
      ).toBe(false);
  ...
  describe('parsePaytrailCallbackUrl', () => {
    it('should return PaytrailCallbackUrl object if input is valid', () => {
      expect(parsePaytrailCallbackUrl(validCallbackUrl)).toEqual(
        validCallbackUrl,
      );
    });
  ...
  describe('explainPaytrailCallbackUrl', () => {
    ...
    it('should return an explanation for invalid objects', () => {
      expect(explainPaytrailCallbackUrl({})).toContain(
        'property "success" not string',
      );
      expect(
        explainPaytrailCallbackUrl({
          ...validCallbackUrl,
      ...
      ).toContain('property "success" not string');
    });
  });
});
