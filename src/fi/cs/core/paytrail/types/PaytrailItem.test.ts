...
describe('PaytrailItem', () => {
  ...
  describe('explainPaytrailItem', () => {
    ...
    it('should return an explanation for invalid objects', () => {
      expect(explainPaytrailItem({...validItem, productCode: 123})).toContain(
        'property "productCode"',
      );
      expect(
        explainPaytrailItem({...validItem, unknownProp: 'test'}),
  ...
  describe('parsePaytrailItem', () => {
    ...
    it('should return undefined for invalid objects', () => {
      expect(
        parsePaytrailItem({...validItem, unitPrice: 'invalid'}),
      ).toBeUndefined();
    });
  });
});
