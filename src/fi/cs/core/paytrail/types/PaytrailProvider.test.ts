import {
  ...
  explainPaytrailProviderOrUndefined,
  isPaytrailProvider,
  isPaytrailProviderOrUndefined,
  parsePaytrailProvider,
...
describe('PaytrailProvider', () => {
  ...
  describe('isPaytrailProviderOrUndefined', () => {
    it('validates if a value is PaytrailProvider or undefined', () => {
      ...
      expect(isPaytrailProviderOrUndefined({url: 'https://testurl.com'})).toBe(
        false,
      ); // Missing other properties.
    });
  });
  ...
  describe('explainPaytrailProviderOrUndefined', () => {
    it('explains why a value is not PaytrailProvider or undefined', () => {
      const result = explainPaytrailProviderOrUndefined({
        url: 'https://testurl.com',
      }); // Missing other properties.
