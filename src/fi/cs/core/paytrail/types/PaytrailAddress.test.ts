import {
  ...
  explainPaytrailAddress,
  isPaytrailAddress,
  isPaytrailAddressOrUndefined,
  parsePaytrailAddress,
  PaytrailAddress,
} from './PaytrailAddress';
...
describe('PaytrailAddress', () => {
  ...
  describe('createPaytrailAddress', () => {
    it('should create a PaytrailAddress object when all inputs are valid', () => {
      const result: PaytrailAddress = createPaytrailAddress(
        streetAddress,
        postalCode,
        city,
        country,
  ...
  describe('isPaytrailAddress', () => {
    ...
    it('should return false for invalid objects', () => {
      expect(
        isPaytrailAddress({...validAddress, unknownProperty: 'Test'}),
      ).toBe(false);
  ...
  describe('parsePaytrailAddress', () => {
    ...
    it('should return undefined if input is invalid', () => {
      expect(
        parsePaytrailAddress({...validAddress, unknownProperty: 'Test'}),
      ).toBeUndefined();
  ...
  describe('explainPaytrailAddress', () => {
    ...
    it('should return an explanation for invalid objects', () => {
      expect(explainPaytrailAddress({})).toContain(
        'property "streetAddress" not string',
      );
      expect(
        explainPaytrailAddress({...validAddress, unknownProperty: 'Test'}),
      ...
      ).toContain('property "streetAddress" not string');
    });
  });
});
