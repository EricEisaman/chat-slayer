import {
  createPaytrailLimitedProvider,
  explainPaytrailLimitedProvider,
  explainPaytrailLimitedProviderOrUndefined,
  isPaytrailLimitedProvider,
  isPaytrailLimitedProviderOrUndefined,
  parsePaytrailLimitedProvider,
} from './PaytrailLimitedProvider';
...
describe('PaytrailLimitedProvider', () => {
  ...
  describe('isPaytrailLimitedProviderOrUndefined', () => {
    it('validates if a value is PaytrailLimitedProvider', () => {
      expect(
        isPaytrailLimitedProviderOrUndefined(mockedPaytrailLimitedProvider),
      ).toBe(true);
