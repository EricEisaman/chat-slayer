import {
  createPaytrailFormField,
  explainPaytrailFormField,
  explainPaytrailFormFieldOrUndefined,
  isPaytrailFormField,
  isPaytrailFormFieldOrUndefined,
  parsePaytrailFormField,
...
describe('PaytrailFormField', () => {
  ...
  describe('isPaytrailFormFieldOrUndefined', () => {
    it('should validate if a value is PaytrailFormField or undefined', () => {
      expect(isPaytrailFormFieldOrUndefined(mockedPaytrailFormField)).toBe(
        true,
      );
