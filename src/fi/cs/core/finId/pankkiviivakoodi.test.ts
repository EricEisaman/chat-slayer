...
describe.skip('pankkiviivakoodi', () => {
  ...
  test('can check valid viivakoodi', () => {
    expect(
      viivakoodiCheck('498142835001711410001001000000000000000000000013160501'),
    ).toBe(true);
    expect(viivakoodiCheck('010171-1234')).toBe(false);
    expect(
      viivakoodiCheck('198142835001711410001001000000000000000000000013160501'),
    ).toBe(false);
  });

  test('can parse viivakoodi version 4', () => {
    const parsed = viivakoodiParse(
      '498142835001711410001001000000000000000000000013160501',
    );
