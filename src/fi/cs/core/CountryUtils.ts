...
export class CountryUtils {
  private static _countryCodeList: readonly CountryCode[] | undefined =
    undefined;
  ...
  public static getCountryList(): readonly Country[] {
    ...
    if (!this._countryList)
      throw TypeError('CountryUtils: Country list not initialized');
  ...
  public static getCountryCodeList(): readonly CountryCode[] {
    ...
    if (!this._countryCodeList)
      throw TypeError('CountryUtils: Country code list not initialized');
  ...
  public static createCountryAutoCompleteValues(
    ...
    return map(list, (item: CountryCode) => [
      item,
      [t(getCountryNameTranslationKey(item))],
    ]) as CountryAutoCompleteMapping;
  }
  ...
  public static parseCountry(
    ...
    return find(allCountries, (item: Country): boolean => {
      ...
      if (
        isCountryCode(iso2) &&
        toLower(trim(t(getCountryNameTranslationKey(iso2)))).replace(
          / +/g,
          ' ',
        ) === name
      ) {
