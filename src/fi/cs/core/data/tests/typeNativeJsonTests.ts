...
export const typeNativeJsonTests = (context: RepositoryTestContext): void => {
  ...
  interface DataRepository extends Repository<DataEntity, string> {
    ...
    findAllByDataJsonBetween(
      start: MyJsonData,
      end: MyJsonData,
      sort?: Sort,
    ): Promise<DataEntity[]>;
    findByDataJsonBetween(
      start: MyJsonData,
      end: MyJsonData,
      sort?: Sort,
    ): Promise<DataEntity | undefined>;
    deleteAllByDataJsonBetween(
      start: MyJsonData,
      end: MyJsonData,
    ): Promise<void>;
    existsByDataJsonBetween(
      start: MyJsonData,
      end: MyJsonData,
    ): Promise<boolean>;
    countByDataJsonBetween(start: MyJsonData, end: MyJsonData): Promise<number>;

    findAllByDataJsonBefore(
      value: MyJsonData,
      sort?: Sort,
    ): Promise<DataEntity[]>;
    findByDataJsonBefore(
      value: MyJsonData,
      sort?: Sort,
    ): Promise<DataEntity | undefined>;
  ...
  beforeEach(async () => {
    ...
    dataRepository = createCrudRepositoryWithPersister<
      DataEntity,
      string,
      DataRepository
    >(new DataEntity(), persister);
    ...
    if (!isDeepStrictEqual(dataEntity1.dataJson, jsonDataEntity1))
      throw new TypeError(
        `barEntity1 data did not initialize correctly: ${dataEntity1.dataJson}`,
      );
    ...
    if (dataEntityId1 === dataEntityId2)
      throw new TypeError(
        `barEntity2 failed to initialize (not unique ID with barEntityId1 and barEntityId2): ${dataEntityId1}`,
      );
    if (!isDeepStrictEqual(dataEntity2.dataJson, jsonDataEntity2))
      throw new TypeError(
        `barEntity2 data did not initialize correctly: ${dataEntity2.dataJson}`,
      );
    ...
    if (dataEntityId1 === dataEntityId3)
      throw new TypeError(
        `barEntityId3 failed to initialize (not unique ID with entity 1): ${dataEntityId1}`,
      );
    if (dataEntityId2 === dataEntityId3)
      throw new TypeError(
        `barEntityId3 failed to initialize (not unique ID with entity 2): ${dataEntityId2}`,
      );
    if (!isDeepStrictEqual(dataEntity3.dataJson, jsonDataEntity3))
      throw new TypeError(
        `barEntity3 data did not initialize correctly: ${dataEntity3.dataJson}`,
      );
    ...
    if (dataEntityId1 === dataEntityId4)
      throw new TypeError(
        `barEntityId4 failed to initialize (not unique ID with entity 1): ${dataEntityId1}`,
      );
    if (dataEntityId2 === dataEntityId4)
      throw new TypeError(
        `barEntityId4 failed to initialize (not unique ID with entity 2): ${dataEntityId2}`,
      );
    if (dataEntityId3 === dataEntityId4)
      throw new TypeError(
        `barEntityId4 failed to initialize (not unique ID with entity 3): ${dataEntityId3}`,
      );
    if (!isDeepStrictEqual(dataEntity4.dataJson, jsonDataEntity4))
      throw new TypeError(
        `barEntity4 data did not initialize correctly: ${dataEntity4.dataJson}`,
      );
  });
  ...
  describe('Create', () => {
    ...
    describe('#saveAll', () => {
      it('can save multiple fresh entities', async () => {
        ...
        const savedItems = await dataRepository.saveAll([
          newEntity1,
          newEntity2,
        ]);
  ...
  describe('Read', () => {
    ...
    describe('#existsByDataJson', () => {
      it('can find if entity exists by dataJson', async () => {
        expect(await dataRepository.existsByDataJson(jsonDataEntity2)).toBe(
          true,
        );
        await dataRepository.deleteAllByDataJson(jsonDataEntity2);
        expect(await dataRepository.existsByDataJson(jsonDataEntity2)).toBe(
    ...
    describe('#findAll', () => {
      ...
      it.skip('can find all entities sorted by name and id in desc order', async () => {
        const items = await dataRepository.findAll(
          Sort.by(Sort.Direction.DESC, 'dataJson.name', 'dataId'),
        );
        expect(items).toBeArray();
        expect(items?.length).toBe(4);
    ...
    describe('#findAllByDataJson', () => {
      ...
      //
      (isMemory ? it : it.skip)(
        'can fetch single entity by dataJson property in asc order',
        async () => {
          const items = await dataRepository.findAllByDataJson(
            jsonDataEntity2,
            Sort.by('dataJson.name'),
          );
          expect(items).toBeArray();
          expect(items?.length).toBe(1);
          expect(items[0]).toBeDefined();
      ...
      //
      (isMemory ? it : it.skip)(
        'can fetch single entity by dataJson property in desc order',
        async () => {
          const items = await dataRepository.findAllByDataJson(
            jsonDataEntity2,
            Sort.by(Sort.Direction.DESC, 'dataJson.name'),
          );
          expect(items).toBeArray();
          expect(items?.length).toBe(1);
          expect(items[0]).toBeDefined();
      ...
      it('can fetch multiple entities by dataJson property unsorted', async () => {
        ...
        if (!dataEntityId5)
          throw new TypeError('barEntity5 failed to initialize');
        if (dataEntityId1 === dataEntityId5)
          throw new TypeError(
            `barEntityId5 failed to initialize (not unique ID with entity 1): ${dataEntityId1}`,
          );
        if (dataEntityId2 === dataEntityId5)
          throw new TypeError(
            `barEntityId5 failed to initialize (not unique ID with entity 2): ${dataEntityId2}`,
          );
        if (dataEntityId3 === dataEntityId5)
          throw new TypeError(
            `barEntityId5 failed to initialize (not unique ID with entity 3): ${dataEntityId3}`,
          );
        if (!isDeepStrictEqual(dataEntity5?.dataJson, jsonDataEntity5))
          throw new TypeError(
            `barEntity5 data did not initialize correctly: ${dataEntity5.dataJson}`,
          );
      ...
      //
      (isMySql ? it.skip : it)(
        'can fetch multiple entities by dataId property in asc order',
        async () => {
          // Initialize as same as entity 1
          dataEntity5 = await persister.insert(
            new DataEntity().getMetadata(),
      ...
      //
      (isMemory ? it : it.skip)(
        'can fetch multiple entities by dataId property in desc order',
        async () => {
          // Initialize as same as entity 1
          dataEntity5 = await persister.insert(
            new DataEntity().getMetadata(),
          ...
          const items = await dataRepository.findAllByDataJson(
            jsonDataEntity1,
            Sort.by(Sort.Direction.DESC, 'dataJson'),
          );
          expect(items).toBeArray();
          expect(items?.length).toBe(2);
    ...
    describe('#findAllById', () => {
      it('can find all entities by id unsorted', async () => {
        const items = await dataRepository.findAllById([
          dataEntityId2,
          dataEntityId3,
        ]);
        expect(items).toBeArray();
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find all entities by id in ascending order',
        async () => {
          const items = await dataRepository.findAllById(
            [dataEntityId2, dataEntityId3],
            Sort.by('dataJson.name'),
          );
          expect(items).toBeArray();
          expect(items?.length).toBe(2);
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find all entities by id in desc order',
        async () => {
          const items = await dataRepository.findAllById(
            [dataEntityId2, dataEntityId3],
            Sort.by(Sort.Direction.DESC, 'dataJson.name'),
    ...
    describe('#find', () => {
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find entities by property in asc order',
        async () => {
          const items = await dataRepository.find(
            'dataJson',
            jsonDataEntity2,
            Sort.by('dataJson.name'),
          );
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find entities by property in desc order',
        async () => {
          const items = await dataRepository.find(
            'dataJson',
            jsonDataEntity2,
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find entities by child property unsorted',
        async () => {
          const items = await dataRepository.find(
            'dataJson.name',
            jsonDataName2,
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find entities by child property in asc order',
        async () => {
          const items = await dataRepository.find(
            'dataJson.name',
            jsonDataName2,
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find entities by child property in desc order',
        async () => {
          const items = await dataRepository.find(
            'dataJson.name',
            jsonDataName2,
    ...
    describe('#findByDataJson', () => {
      it('can find entity by dataJson property unsorted', async () => {
        const entity: DataEntity | undefined =
          await dataRepository.findByDataJson(jsonDataEntity2);
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find entity by dataJson property in asc order',
        async () => {
          const entity: DataEntity | undefined =
            await dataRepository.findByDataJson(
              jsonDataEntity2,
              Sort.by('dataJson.name'),
            );
          expect(entity).toBeDefined();
      ...
      //       - MySQL: Failed
      (isMemory ? it : it.skip)(
        'can find entity by dataJson property in desc order',
        async () => {
          const entity: DataEntity | undefined =
            await dataRepository.findByDataJson(
              jsonDataEntity2,
    ...
    describe('#findById', () => {
      ...
      it.skip('can find entity by id by asc order', async () => {
        const item = await dataRepository.findById(
          dataEntityId2,
          Sort.by('dataJson.name'),
        );
        expect(item).toBeDefined();
  ...
  describe('Delete', () => {
    describe('#delete', () => {
      it('can delete entity by entity object', async () => {
        ...
        const entity: DataEntity | undefined =
          await dataRepository.findById(dataEntityId2);
    ...
    describe('#deleteAll', () => {
      ...
      //       - MySQL: Failed
      (isMySql ? it.skip : it)(
        'can delete few entities with an array of entities',
        async () => {
          expect(await dataRepository.count()).toBe(4);
          await dataRepository.deleteAll([dataEntity2, dataEntity3]);
          expect(await dataRepository.count()).toBe(2);

          const entity1: DataEntity | undefined =
            await dataRepository.findById(dataEntityId1);
          expect(entity1).toBeDefined();

          const entity2: DataEntity | undefined =
            await dataRepository.findById(dataEntityId2);
          expect(entity2).not.toBeDefined();

          const entity3: DataEntity | undefined =
            await dataRepository.findById(dataEntityId3);
          expect(entity3).not.toBeDefined();

          const entity4: DataEntity | undefined =
            await dataRepository.findById(dataEntityId4);
    ...
    describe('#deleteAllById', () => {
      ...
      it('can delete all entities by few ids', async () => {
        expect(await dataRepository.count()).toBe(4);
        await dataRepository.deleteAllById([dataEntityId2, dataEntityId3]);
        expect(await dataRepository.count()).toBe(2);
  ...
  describe('Between', () => {
    describe('#findAllByDataJsonBetween', () => {
      ...
      it.skip('can find all entities between values by date unordered', async () => {
        const items = await dataRepository.findAllByDataJsonBetween(
          {name: '1'},
          {name: '2'},
        );
    ...
    describe('#findByDataJsonBetween', () => {
      ...
      it.skip('can find an entity between times in unsorted order', async () => {
        const item = await dataRepository.findByDataJsonBetween(
          jsonDataBetween3And4,
          jsonDataAfter4,
        );
    ...
    describe('#deleteAllByDataJsonBetween', () => {
      ...
      it.skip('can delete all entities by barDate between range', async () => {
        await dataRepository.deleteAllByDataJsonBetween(
          jsonDataBefore1,
          jsonDataBetween3And4,
        );
    ...
    describe('#existsByDataJsonBetween', () => {
      ...
      //       - MySQL: Failed
      (isMySql ? it.skip : it)(
        'can find if entities exist between range',
        async () => {
          expect(
            await dataRepository.existsByDataJsonBetween(
              jsonDataBetween1And2,
              jsonDataBetween3And4,
            ),
          ).toBe(true);
    ...
    describe('#countByDataJsonBetween', () => {
      ...
      it.skip('can count entities by dataId', async () => {
        expect(
          await dataRepository.countByDataJsonBetween(
            jsonDataBetween1And2,
            jsonDataAfter4,
          ),
        ).toBe(3);
  ...
  describe('Before', () => {
    describe('#findAllByDataJsonBefore', () => {
      ...
      it.skip('can find all entities before time, unordered', async () => {
        ...
        const items =
          await dataRepository.findAllByDataJsonBefore(jsonDataBetween2And3);
        expect(items).toHaveLength(2);
      ...
      it.skip('can find all entities before time, in asc order', async () => {
        ...
        const items = await dataRepository.findAllByDataJsonBefore(
          jsonDataBetween2And3,
          Sort.by('dataJson.name'),
        );
        expect(items).toHaveLength(2);
    ...
    describe('#findByDataJsonBefore', () => {
      ...
      //       - MySQL: Failed
      (isMySql ? it.skip : it)(
        'cannot find an entity before there was any',
        async () => {
          const item =
            await dataRepository.findByDataJsonBefore(jsonDataBefore1);
      ...
      //       - MySQL: Failed
      (isPg ? it : it.skip)(
        'can find an entity before time in unsorted order',
        async () => {
          // Matches entity 1
          const item =
            await dataRepository.findByDataJsonBefore(jsonDataBetween1And2);
          expect(item?.dataId).toBe(dataEntityId1);
          expect(item?.dataJson).toStrictEqual(jsonDataEntity1);
        },
      );
      ...
      it.skip('can find an entity before time in asc order', async () => {
        // Matches entity 1
        const item = await dataRepository.findByDataJsonBefore(
          jsonDataBetween3And4,
          Sort.by('dataJson.name'),
        );
        expect(item?.dataId).toBe(dataEntityId1);
    ...
    describe('#existsByDataJsonBefore', () => {
      ...
      //       - MySQL: Failed
      (isPg ? it : it.skip)(
        'can find if entities exist before time',
        async () => {
          expect(
            await dataRepository.existsByDataJsonBefore(jsonDataBetween1And2),
          ).toBe(true);
    ...
    describe('#countByDataJsonBefore', () => {
      ...
      it.skip('can count entities before time', async () => {
        ...
        expect(
          await dataRepository.countByDataJsonBefore(jsonDataBetween3And4),
        ).toBe(3);
  ...
  describe('After', () => {
    describe('#findAllByDataJsonAfter', () => {
      ...
      it.skip('can find all entities after time, unordered', async () => {
        ...
        const items =
          await dataRepository.findAllByDataJsonAfter(jsonDataBetween2And3);
        expect(items).toHaveLength(2);
      ...
      it.skip('can find all entities after time in asc order', async () => {
        ...
        const items = await dataRepository.findAllByDataJsonAfter(
          jsonDataBetween2And3,
          Sort.by('dataJson.name'),
        );
        expect(items).toHaveLength(2);
    ...
    describe('#findByDataJsonAfter', () => {
      ...
      it.skip('can find an entity after time in unsorted order', async () => {
        // Matches 4
        const item =
          await dataRepository.findByDataJsonAfter(jsonDataBetween3And4);
        expect(item?.dataId).toBe(dataEntityId4);
        expect(item?.dataJson).toStrictEqual(jsonDataEntity4);
      });
      ...
      it.skip('can find an entity after time in asc order', async () => {
        ...
        const item = await dataRepository.findByDataJsonAfter(
          jsonDataBetween1And2,
          Sort.by('dataJson.name'),
        );
        expect(item?.dataId).toBe(dataEntityId2);
    ...
    describe('#existsByDataJsonAfter', () => {
      ...
      it.skip('can find if entities exist after barDate', async () => {
        expect(
          await dataRepository.existsByDataJsonAfter(jsonDataBetween1And2),
        ).toBe(true);
        await dataRepository.deleteAllByDataJsonBetween(
          jsonDataBetween1And2,
          jsonDataAfter4,
        ); // Deletes items 2, 3 and 4
        expect(
          await dataRepository.existsByDataJsonAfter(jsonDataBetween1And2),
        ).toBe(false);
      });
    ...
    describe('#countByDataJsonAfter', () => {
      ...
      it.skip('can count entities after barDate', async () => {
        expect(
          await dataRepository.countByDataJsonAfter(jsonDataBetween1And2),
        ).toBe(3);
        await dataRepository.deleteAllByDataJsonAfter(jsonDataBetween1And2);
        expect(await dataRepository.countByDataJsonAfter(jsonDataBefore1)).toBe(
          1,
        );
      });
    });
