...
export function isMySqlCharset(value: unknown): value is MySqlCharset {
  switch (value) {
...
export function explainMySqlCharset(value: unknown): string {
...
export function parseMySqlCharset(value: unknown): MySqlCharset | undefined {
  if (value === undefined) return undefined;
  switch (`${value}`.toUpperCase()) {
    case 'UTF8_GENERAL_CI':
      return MySqlCharset.UTF8_GENERAL_CI;
    case 'LATIN1_SWEDISH_CI':
      return MySqlCharset.LATIN1_SWEDISH_CI;
    default:
      return undefined;
  }
}
