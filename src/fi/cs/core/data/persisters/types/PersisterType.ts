...
export function parsePersisterType(value: unknown): PersisterType | undefined {
  return parseEnum(PersisterType, value) as PersisterType | undefined;
}

export function isPersisterTypeOrUndefined(
  value: unknown,
): value is PersisterType | undefined {
...
export function explainPersisterTypeOrUndefined(value: unknown): string {
  return isPersisterTypeOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['PersisterType', 'undefined']));
}
