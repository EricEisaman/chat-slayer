...
export function isEntityCallbackType(
  value: unknown,
): value is EntityCallbackType {
...
export function parseEntityCallbackType(
  value: unknown,
): EntityCallbackType | undefined {
  return parseEnum(EntityCallbackType, value) as EntityCallbackType | undefined;
}

export function isEntityCallbackTypeOrUndefined(
  value: unknown,
): value is EntityCallbackType | undefined {
...
export function explainEntityCallbackTypeOrUndefined(value: unknown): string {
  return isEntityCallbackTypeOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['EntityCallbackType', 'undefined']));
}
