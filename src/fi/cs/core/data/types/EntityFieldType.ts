...
export function parseEntityFieldType(
  value: unknown,
): EntityFieldType | undefined {
  return parseEnum(EntityFieldType, value) as EntityFieldType | undefined;
}

export function isEntityFieldTypeOrUndefined(
  value: unknown,
): value is EntityFieldType | undefined {
...
export function explainEntityFieldTypeOrUndefined(value: unknown): string {
  return isEntityFieldTypeOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['EntityFieldType', 'undefined']));
}
