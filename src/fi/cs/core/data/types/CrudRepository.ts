...
>(emptyEntity: T, persister: Persister): RepositoryType {
  ...
  RepositoryUtils.generateDefaultMethods<T, ID>(
    FinalCrudRepositoryImpl.prototype,
    entityMetadata,
  );
