...
export class PgArgumentListBuilder implements QueryBuilder {
  ...
  public toString(): string {
    return `PgArgumentListBuilder "${this.buildQueryString()}" with ${this.buildQueryValues()
      .map(item => item())
      .join(' ')}`;
  }
   ...
   * @param columnName The column name in the table where to read the value
   */
  public setTableColumnAsText(tableName: string, columnName: string) {
    this._queryList.push(() =>
   ...
   * @param columnName The column name in the table where to read the value
   */
  public setTableColumnAsTimestamp(tableName: string, columnName: string) {
    this._queryList.push(() =>
  ...
  public setParamFactory(value: () => any) {
    this._queryList.push(() => PgQueryUtils.getValuePlaceholder());
    this._valueList.push(value);
  }
   ...
   * @param value
   */
  public setParamAsText(value: any) {
   ...
   * @param value
   */
  public setParamAsTimestamp(value: any) {
    this._queryList.push(() =>
