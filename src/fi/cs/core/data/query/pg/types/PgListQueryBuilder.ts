...
export class PgListQueryBuilder extends BaseListQueryBuilder {
  ...
  public static create(separator?: string): PgListQueryBuilder {
   ...
   * @inheritDoc
   */
  public setParam(value: unknown): void {
   ...
   * @inheritDoc
   */
  public setParamAsText(value: unknown): void {
    this.appendExpression(
   ...
   * @inheritDoc
   */
  public setParamFromJson(value: unknown): void {
    this.appendExpression(
      () => PgQueryUtils.getValuePlaceholder(),
      () => value,
    );
   ...
   * @inheritDoc
   */
  public setParamFromTimestampString(value: unknown): void {
    this.appendExpression(
   ...
   * @inheritDoc
   */
  public setParamAsTimestampValue(value: unknown): void {
    this.appendExpression(
   ...
   * @inheritDoc
   */
  public setParamFactory(factory: () => any): void {
    this.appendExpression(() => PgQueryUtils.getValuePlaceholder(), factory);
  }
   ...
   * @inheritDoc
   */
  public setTableColumnAsTimestampString(
    tableName: string,
    columnName: string,
  ): void {
    this.appendExpression(() =>
   ...
   * @inheritDoc
   */
  public setAssignmentWithParam(columnName: string, value: any): void {
    this.appendExpression(
      () =>
   ...
   * @inheritDoc
   */
  public setAssignmentWithParamAsJson(columnName: string, value: any): void {
    this.appendExpression(
      () =>
        `${PgQueryUtils.quoteColumnName(columnName)} = ${PgQueryUtils.getValuePlaceholder()}`,
      () => value,
