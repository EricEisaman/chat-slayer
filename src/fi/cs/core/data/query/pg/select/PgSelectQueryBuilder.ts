  ...
  implements SelectQueryBuilder
{
  ...
  public includeFormulaByString(formula: string, asColumnName: string): void {
    ...
    this.appendResultExpression(() => PG_PH_AS(formula, asColumnName));
  }
  ...
  public includeColumn(
    ...
    this.appendResultExpression(() =>
      PgQueryUtils.quoteTableAndColumnAsColumnName(
  ...
  public includeColumnAsText(
    ...
    this.appendResultExpression(() =>
      PgQueryUtils.quoteTableAndColumnAsTextAsColumnName(
        this.getTableNameWithPrefix(tableName),
        columnName,
        asColumnName,
      ),
  ...
  public includeColumnAsDate(
    ...
    this.appendResultExpression(() =>
      PgQueryUtils.quoteTableAndColumnAsTimestampStringAsColumnName(
        this.getTableNameWithPrefix(tableName),
        columnName,
        asColumnName,
      ),
   ...
   */
  public override setWhereFromQueryBuilder(builder: QueryBuilder): void {
  ...
  public toString(): string {
    return `PgSelectQueryBuilder "${this.buildQueryString()}" with ${this.buildQueryValues()
      .map(item => item())
      .join(' ')}`;
  }
