...
export interface ListQueryBuilder extends QueryBuilder {
   ...
   */
  setTableColumn(tableName: string, columnName: string): void;
   ...
   * @param columnName The column name in the table where to read the value
   */
  setTableColumnAsText(tableName: string, columnName: string): void;
   ...
   * @param columnName The column name in the table where to read the value
   */
  setTableColumnAsTimestampString(tableName: string, columnName: string): void;
   ...
   * @param value
   */
  setParamFactory(value: () => any): void;
   ...
   * @param value
   */
  setParamFromJson(value: any): void;
   ...
   * @param value
   */
  setParamFromTimestampString(value: any): void;
   ...
   * @param value
   */
  setParamAsTimestampValue(value: any): void;
   ...
   * @param value
   */
  setAssignmentWithParam(columnName: string, value: any): void;
   ...
   */
  setAssignmentWithParamAsTimestamp(columnName: string, value: any): void;
   ...
   * @param value The time value
   */
  setAssignmentWithParamAsJson(columnName: string, value: any): void;
