...
export interface ChainQueryBuilder extends QueryBuilder {
   ...
   */
  setColumnEquals(tableName: string, columnName: string, value: any): void;
   ...
   * @param columnName The column name
   */
  setColumnIsNull(tableName: string, columnName: string): void;
   ...
   * @param value The value
   */
  setColumnBefore(tableName: string, columnName: string, value: any): void;
   ...
   * @param value The value
   */
  setColumnAfter(tableName: string, columnName: string, value: any): void;
   ...
   * @param value The value
   */
  setColumnAfterAsTime(tableName: string, columnName: string, value: any): void;
   ...
   * @param builder
   */
  setFromQueryBuilder(builder: QueryBuilder): void;
