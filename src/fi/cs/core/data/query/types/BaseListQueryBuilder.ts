...
export abstract class BaseListQueryBuilder implements ListQueryBuilder {
   ...
   * @inheritDoc
   */
  public abstract setTableColumn(tableName: string, columnName: string): void;
   ...
   * @inheritDoc
   */
  public abstract setParam(value: any): void;

  /**
   * @inheritDoc
   */
  public abstract setParamFactory(value: () => any): void;

  /**
   * @inheritDoc
   */
  public abstract setParamAsText(value: any): void;

  /**
   * @inheritDoc
   */
  public abstract setParamFromJson(value: any): void;

  /**
   * @inheritDoc
   */
  public abstract setParamFromTimestampString(value: any): void;

  /**
   * @inheritDoc
   */
  public abstract setParamAsTimestampValue(value: any): void;

  /**
   * @inheritDoc
   */
  public abstract setAssignmentWithParam(columnName: string, value: any): void;
