...
export class MySqlSelectQueryBuilder
  ...
  implements SelectQueryBuilder
{
   ...
   * @inheritDoc
   */
  public override appendResultExpression(
    queryFactory: () => string,
    ...valueFactories: QueryValueFactory[]
  ): void {
    super.appendResultExpression(queryFactory, ...valueFactories);
  }

  /**
   * @inheritDoc
   */
  public override appendResultExpressionUsingQueryBuilder(
    builder: QueryBuilder,
    ...valueFactories: QueryValueFactory[]
  ): void {
    super.appendResultExpressionUsingQueryBuilder(builder, ...valueFactories);
  }
  ...
  public includeColumnFromQueryBuilder(
    ...
    if (!asColumnName) {
      throw new TypeError(
        'includeColumnFromQueryBuilder: column name is required',
      );
    }
    this.appendResultExpression(
   ...
   * @inheritDoc
   */
  public override appendLeftJoinExpression(
    queryFactory: () => string,
    ...valueFactories: QueryValueFactory[]
  ): void {
    super.appendLeftJoinExpression(queryFactory, ...valueFactories);
  }

  /**
   * @inheritDoc
   */
  public override appendLeftJoinExpressionUsingQueryBuilder(
    builder: QueryBuilder,
    ...valueFactories: QueryValueFactory[]
  ): void {
    super.appendLeftJoinExpressionUsingQueryBuilder(builder, ...valueFactories);
  }
   ...
   * @inheritDoc
   */
  public override appendOrderExpression(
    queryFactory: () => string,
    ...valueFactories: QueryValueFactory[]
  ): void {
    super.appendOrderExpression(queryFactory, ...valueFactories);
  }

  /**
   * @inheritDoc
   */
  public override appendOrderExpressionUsingQueryBuilder(
    builder: QueryBuilder,
    ...valueFactories: QueryValueFactory[]
  ): void {
    super.appendOrderExpressionUsingQueryBuilder(builder, ...valueFactories);
  }
  ...
  public setOrderByTableFields(
    ...
    forEach(sort.getSortOrders(), item => {
   ...
   */
  public override setGroupByColumn(columnName: string) {
   ...
   */
  public override getGroupByColumn(): string | undefined {
   ...
   */
  public override setTablePrefix(prefix: string) {
   ...
   */
  public override setTableName(tableName: string) {
  ...
  public toString(): string {
    return `"${this.buildQueryString()}" with ${this.buildQueryValues()
      .map(item => item())
      .join(' ')}`;
  }
