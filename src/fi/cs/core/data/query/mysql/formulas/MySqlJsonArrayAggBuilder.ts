...
export class MySqlJsonArrayAggBuilder extends FunctionQueryBuilder {
  public constructor(distinct: boolean) {
    super(distinct, 'JSON_ARRAYAGG');
  }

  ///////////////////         FunctionQueryBuilder         ///////////////////

  public override setFormulaFromQueryBuilder(builder: QueryBuilder) {
    super.setFormulaFromQueryBuilder(builder);
  }

  ///////////////////////         QueryBuilder         ///////////////////////

  public override build(): readonly [string, readonly any[]] {
    return super.build();
  }
  ...
  public override buildQueryString(): string {
    if (this._distinct) {
      if (!this._builder)
        throw new TypeError(
          'Could not build JSON_ARRAYAGG() query: Query builder not initialized',
        );
  ...
  public override getQueryValueFactories(): readonly (() => any)[] {
