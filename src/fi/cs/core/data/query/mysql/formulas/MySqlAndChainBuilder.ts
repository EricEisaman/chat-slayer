...
import {
  MY_PH_TABLE_COLUMN_AFTER,
  MY_PH_TABLE_COLUMN_AFTER_AS_TIME,
  MY_PH_TABLE_COLUMN_BEFORE,
  MY_PH_TABLE_COLUMN_BEFORE_AS_TIME,
  MY_PH_TABLE_COLUMN_BETWEEN_RANGE,
  MY_PH_TABLE_COLUMN_BETWEEN_RANGE_AS_TIME,
  MY_PH_TABLE_COLUMN_EQUAL,
  MY_PH_TABLE_COLUMN_EQUAL_AS_JSON,
  MY_PH_TABLE_COLUMN_EQUAL_AS_TIME,
  MY_PH_TABLE_COLUMN_EQUALS_LAST_INSERT_ID,
  MY_PH_TABLE_COLUMN_IN,
  MY_PH_TABLE_COLUMN_IN_AS_TIME,
  MY_PH_TABLE_COLUMN_IS_NULL,
...
export class MySqlAndChainBuilder implements ChainQueryBuilder {
  ...
  public setColumnIsNull(tableName: string, columnName: string) {
  ...
  public setColumnInListAsTime(
    ...
    this._formulaValues.push(() => tableName);
    this._formulaValues.push(() => columnName);
    this._formulaValues.push(() =>
      map(values, i => EntityUtils.parseIsoStringAsMySQLDateString(i)),
    );
  }
  ...
  public setColumnBetweenAsTime(
    ...
    this._formulaValues.push(() => columnName);
    this._formulaValues.push(() =>
      EntityUtils.parseIsoStringAsMySQLDateString(start),
    );
    this._formulaValues.push(() =>
      EntityUtils.parseIsoStringAsMySQLDateString(end),
    );
  }
  ...
  public setColumnEqualsByLastInsertId(tableName: string, columnName: string) {
