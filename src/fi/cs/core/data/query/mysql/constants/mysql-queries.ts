...
export const MY_PH_ASSIGN_TIMESTAMP_VALUE =
...
export const MY_PH_FROM_TIME_TABLE_COLUMN_AS_TIME =
  "TIME_FORMAT(??.??, '%Y-%m-%dT%TZ')";
export const MY_PH_FROM_DATE_TABLE_COLUMN_AS_DATE =
  "DATE_FORMAT(??.??, '%Y-%m-%dT%TZ')";
export const MY_PH_FROM_TIMESTAMP_TABLE_COLUMN_AS_TIMESTAMP =
  "DATE_FORMAT(??.??, '%Y-%m-%dT%TZ')";
export const MY_PH_AS = (value: string) => `${value} AS ??`;
export const MY_PH_TABLE_COLUMN_AS_TEXT_AS = MY_PH_AS(
  MY_PH_TABLE_COLUMN_AS_TEXT,
);
export const MY_PH_TABLE_COLUMN_AS_TIME_AS = MY_PH_AS(
  MY_PH_FROM_TIME_TABLE_COLUMN_AS_TIME,
);
export const MY_PH_TABLE_COLUMN_AS_DATE_AS = MY_PH_AS(
  MY_PH_FROM_DATE_TABLE_COLUMN_AS_DATE,
);
export const MY_PH_TABLE_COLUMN_AS_TIMESTAMP_AS = MY_PH_AS(
  MY_PH_FROM_TIMESTAMP_TABLE_COLUMN_AS_TIMESTAMP,
);
export const MY_PH_TABLE_COLUMN_WITH_SORT_ORDER = (
  order: SortDirection,
): string => `??.??${order === SortDirection.ASC ? '' : ' DESC'}`;
...
export const MY_PH_TABLE_COLUMN_EQUALS_LAST_INSERT_ID =
  '??.?? = LAST_INSERT_ID()';
