  ...
  describe('#buildChain', () => {
    ...
    it('builds chain for equal condition', () => {
      ...
      ChainQueryBuilderUtils.buildChain(
        ...
        fields,
        temporalProperties,
        mockAndBuilderFactory,
        mockOrBuilderFactory,
      );

      expect(mockAndBuilder.setColumnEquals).toHaveBeenCalledWith(
        completeTableName,
        'city_column',
        'New York',
      );
    ...
    it('builds chain for before condition', () => {
      ...
      expect(mockAndBuilder.setColumnBefore).toHaveBeenCalledWith(
        completeTableName,
        'age_column',
        30,
      );
    ...
    it('builds chain for after condition', () => {
      ...
      expect(mockAndBuilder.setColumnAfter).toHaveBeenCalledWith(
        completeTableName,
        'age_column',
        30,
      );
    ...
    it('builds chain for between condition', () => {
      ...
      expect(mockAndBuilder.setColumnBetween).toHaveBeenCalledWith(
        completeTableName,
        'age_column',
        18,
        30,
    ...
    it('builds chain for AndCondition', () => {
      ...
      expect(mockAndBuilder.setColumnEquals).toHaveBeenNthCalledWith(
        1,
        'tableName',
        'city_column',
        'New York',
    ...
    it('builds chain for OrCondition', () => {
      ...
      expect(mockOrBuilder.setFromQueryBuilder).toHaveBeenNthCalledWith(
        1,
        mockAndBuilder,
      );
      expect(mockOrBuilder.setFromQueryBuilder).toHaveBeenNthCalledWith(
