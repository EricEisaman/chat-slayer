...
export function isNewSimpleDTO(value: unknown): value is NewSimpleDTO {
  return (
    isRegularObject(value) &&
    hasNoOtherKeysInDevelopment(value, ['data', 'members']) &&
...
export function parseNewSimpleDTO(value: unknown): NewSimpleDTO | undefined {
