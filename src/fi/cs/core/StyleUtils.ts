import {
  ColorMapping,
  ComponentStyleLayoutMapping,
  FontMapping,
  SizeMapping,
  StyleLayout,
} from './style/StyleLayout';
...
} from './style/compiled/BackgroundStyle';
import {Size} from './style/types/Size';
import {
  ComponentStyle,
  createComponentStyle,
} from './style/compiled/ComponentStyle';
...
export class StyleUtils {
  ...
  public static compileBackgroundStyle(
    ...
    return createBackgroundStyle(colorId ? get(colors, colorId) : undefined);
  }
  ...
  public static findLayoutByColorScheme(
    ...
    const list = filter(
      layouts,
      (item: StyleLayout): boolean => item.colorScheme === colorScheme,
    );
