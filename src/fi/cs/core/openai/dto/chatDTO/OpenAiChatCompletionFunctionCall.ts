...
export function isOpenAiChatCompletionFunctionCall(
  value: unknown,
): value is OpenAiChatCompletionFunctionCall {
  return (
    isRegularObject(value) &&
    hasNoOtherKeysInDevelopment(value, ['name', 'args']) &&
    isString(objectKey(value, 'name')) &&
    isString(objectKey(value, 'args'))
  );
}
 ...
 */
export function explainOpenAiChatCompletionFunctionCall(
  value: unknown,
): string {
  return explain([
    explainRegularObject(value),
    explainNoOtherKeys(value, ['name', 'args']),
