...
describe('OpenAiCompletionResponseChoice', () => {
  describe('createOpenAiCompletionResponseChoice', () => {
    it('creates a valid OpenAiCompletionResponseChoice object', () => {
      const item1: OpenAiCompletionResponseChoice =
        createOpenAiCompletionResponseChoice(
          'completed text',
          0,
          null,
      ...
      const item2: OpenAiCompletionResponseChoice =
        createOpenAiCompletionResponseChoice(
          'more completed text',
          1,
          3,
  ...
  describe('explainOpenAiCompletionResponseChoice', () => {
    ...
    it('returns a human-readable string explaining why the value is not a valid OpenAiCompletionResponseChoice', () => {
      expect(explainOpenAiCompletionResponseChoice({extra: 'key'})).toMatch(
        /Value had extra properties: extra/,
      );
      expect(explainOpenAiCompletionResponseChoice('foo')).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice(undefined)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice(null)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice(true)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice(false)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice(0)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice(1)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice('')).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice('test')).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseChoice([])).toMatch(
        /not regular object/,
      ...
      expect(explainOpenAiCompletionResponseChoice(Symbol())).toMatch(
        /not regular object/,
      );
    });
  });
  ...
  describe('stringifyOpenAiCompletionResponseChoice', () => {
    it("should return the string 'OpenAiCompletionResponseChoice({...})'", () => {
      ...
      const expected =
        'OpenAiCompletionResponseChoice({"text":"This is a test","index":2,"logprobs":null,"finish_reason":"length"})';
  ...
  describe('parseOpenAiCompletionResponseChoice', () => {
    it('parses a valid OpenAiCompletionResponseChoice string representation', () => {
      const string =
        'OpenAiCompletionResponseChoice({"text":"text","index":1,"logprobs":null,"finish_reason":"length"})';
