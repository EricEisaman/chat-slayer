 ...
 */
export function isOpenAiEditResponseUsage(
  value: unknown,
): value is OpenAiEditResponseUsage {
  return (
 ...
 */
export function explainOpenAiEditResponseUsage(value: unknown): string {
  return explain([
 ...
 */
export function stringifyOpenAiEditResponseUsage(
  value: OpenAiEditResponseUsage,
): string {
 ...
 */
export function parseOpenAiEditResponseUsage(
  value: unknown,
): OpenAiEditResponseUsage | undefined {
  if (isString(value)) {
    if (startsWith(value, 'OpenAiEditResponseUsage(')) {
      value = value.substring(
        'OpenAiEditResponseUsage('.length,
        value.length - 1,
      );
    }
