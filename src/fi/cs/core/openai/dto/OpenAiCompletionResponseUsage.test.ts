...
describe('OpenAiCompletionResponseUsage', () => {
  describe('createOpenAiCompletionResponseUsage', () => {
    it('creates a valid OpenAiCompletionResponseUsage object', () => {
      const item1: OpenAiCompletionResponseUsage =
        createOpenAiCompletionResponseUsage(1, 2, 3);
      ...
      const item2: OpenAiCompletionResponseUsage =
        createOpenAiCompletionResponseUsage(2, 3, 4);
  ...
  describe('explainOpenAiCompletionResponseUsage', () => {
    ...
    it('returns a human-readable string explaining why the value is not a valid OpenAiCompletionResponseUsage', () => {
      expect(explainOpenAiCompletionResponseUsage({extra: 'key'})).toMatch(
        /Value had extra properties: extra/,
      );
      expect(explainOpenAiCompletionResponseUsage('foo')).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage(undefined)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage(null)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage(true)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage(false)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage(0)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage(1)).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage('')).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage('test')).toMatch(
        /not regular object/,
      );
      expect(explainOpenAiCompletionResponseUsage([])).toMatch(
        /not regular object/,
      ...
      expect(explainOpenAiCompletionResponseUsage(Symbol())).toMatch(
        /not regular object/,
      );
    });
  });
  ...
  describe('stringifyOpenAiCompletionResponseUsage', () => {
    it("should return the string 'OpenAiCompletionResponseUsage({...})'", () => {
      ...
      const expected =
        'OpenAiCompletionResponseUsage({"prompt_tokens":1,"completion_tokens":2,"total_tokens":3})';
