...
} from './OpenAiCompletionResponseDTO';
...
describe('OpenAiCompletionResponseDTO', () => {
  describe('createOpenAiCompletionResponseDTO', () => {
    it('creates a valid OpenAiCompletionResponseDTO object', () => {
      ...
      const usage = createOpenAiCompletionResponseUsage(1, 2, 3);
  ...
  describe('isOpenAiCompletionResponseDTO', () => {
    it('returns true for valid OpenAiCompletionResponseDTO objects', () => {
      const validOpenAiCompletionResponseDTO =
        createOpenAiCompletionResponseDTO(
          'response-id',
          'text_completion',
          1589478378,
      ...
      expect(
        isOpenAiCompletionResponseDTO(validOpenAiCompletionResponseDTO),
      ).toBe(true);
    });
    ...
    it('returns false for objects with missing properties', () => {
      ...
      expect(
        isOpenAiCompletionResponseDTO(incompleteOpenAiCompletionResponseDTO),
      ).toBe(false);
    });
    ...
    it('returns false for a value with an extra key', () => {
      expect(
        isOpenAiCompletionResponseDTO({
          ...
          usage: createOpenAiCompletionResponseUsage(1, 2, 3),
