...
export function isOpenAiUserType(value: unknown): value is OpenAiUserType {
  switch (value) {
...
export function parseOpenAiUserType(
  value: unknown,
): OpenAiUserType | undefined {
  switch (`${value}`.toLowerCase()) {
    case 'user':
      return OpenAiUserType.USER;
    case 'system':
      return OpenAiUserType.SYSTEM;
    case 'assistant':
      return OpenAiUserType.ASSISTANT;
    case 'function':
      return OpenAiUserType.FUNCTION;
    default:
      return undefined;
  }
}
