 ...
 */
export function parseOpenAiModel(value: unknown): OpenAiModel | undefined {
  ...
  switch (`${value}`.toLowerCase()) {
    ...
    case 'text-davinci-edit-001':
      return OpenAiModel.DAVINCI_EDIT_TEXT;

    case 'code_edit':
    case 'code-edit':
    case 'code_davinci_edit_001':
    case 'code-davinci-edit-001':
      return OpenAiModel.DAVINCI_EDIT_CODE;
    ...
    case 'content-filter-alpha':
      return OpenAiModel.CONTENT_FILTER;

    case 'codex':
    case 'code_davinci_002':
    case 'code-davinci-002':
      return OpenAiModel.CODEX;
    ...
    case 'gpt-3.5-turbo-16k':
      return OpenAiModel.GPT_3_5_TURBO_16K;
