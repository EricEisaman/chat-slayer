...
import {
  explainOpenAiCompletionResponseDTO,
  isOpenAiCompletionResponseDTO,
  OpenAiCompletionResponseDTO,
} from './dto/OpenAiCompletionResponseDTO';
...
import {
  explainOpenAiEditResponseDTO,
  isOpenAiEditResponseDTO,
  OpenAiEditResponseDTO,
} from './dto/OpenAiEditResponseDTO';
...
export class HttpOpenAiClient implements OpenAiClient {
  ...
  public async getCompletion(
    ...
    if (!isOpenAiCompletionResponseDTO(result)) {
      ...
      throw new TypeError(
        'Result was not OpenAiCompletionResponseDTO: ' +
          explainOpenAiCompletionResponseDTO(result),
      );
    }
  ...
  public async getChatCompletion(
    ...
    if (!isOpenAiChatCompletionResponseDTO(result)) {
      ...
      throw new TypeError(
        'Result was not OpenAiChatCompletionResponseDTO: ' +
          explainOpenAiChatCompletionResponseDTO(result),
      );
    }
  ...
  public async getEdit(
    ...
    if (!isOpenAiEditResponseDTO(result)) {
      ...
      throw new TypeError(
        'Result was not OpenAiEditResponseDTO: ' +
          explainOpenAiEditResponseDTO(result),
      );
    }
  ...
  private static _getHeaders(apiKey: string) {
    return {
      [OPENAPI_AUTHORIZATION_HEADER]:
        AuthorizationUtils.createBearerHeader(apiKey),
    };
  }
}
