...
export class LanguageService {
  ...
  private static _observer: Observer<LanguageServiceEvent> =
    new Observer<LanguageServiceEvent>('LanguageService');
  ...
  public static setDefaultLanguage(lang: Language) {
    if (this._defaultLanguage !== lang) {
      ...
      if (
        this._observer.hasCallbacks(
          LanguageServiceEvent.DEFAULT_LANGUAGE_CHANGED,
        )
      ) {
