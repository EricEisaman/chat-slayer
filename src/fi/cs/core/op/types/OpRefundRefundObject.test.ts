...
import {
  createOpRefundRefundObject,
  explainOpRefundRefundObject,
  explainOpRefundRefundObjectOrUndefined,
  isOpRefundRefundObject,
  isOpRefundRefundObjectOrUndefined,
  OpRefundRefundObject,
  parseOpRefundRefundObject,
} from './OpRefundRefundObject';
...
describe('OpRefundRefundObject functions', () => {
  ...
  describe('explainOpRefundRefundObject', () => {
    ...
    it('should provide explanations for invalid properties', () => {
      ...
      expect(explainOpRefundRefundObject(invalidObject)).toContain(
        'property "amount"',
      );
    });
  });
  ...
  describe('explainOpRefundRefundObjectOrUndefined', () => {
    it('should explain a valid object correctly', () => {
      expect(explainOpRefundRefundObjectOrUndefined(validObject)).toContain(
        'OK',
      ); // Assuming "OK" is part of a valid explanation.
    });
    ...
    it('should provide explanations for invalid properties', () => {
      const invalidObject = {...validObject, amount: 100}; // changed amount to a number
      expect(explainOpRefundRefundObjectOrUndefined(invalidObject)).toContain(
        'OpRefundRefundObject',
      );
    });
  });
