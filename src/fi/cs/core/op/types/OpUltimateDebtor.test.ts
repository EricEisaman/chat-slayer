import {
  ...
  explainOpUltimateDebtor,
  explainOpUltimateDebtorOrUndefined,
  isOpUltimateDebtor,
  isOpUltimateDebtorOrUndefined,
  OpUltimateDebtor,
  parseOpUltimateDebtor,
} from './OpUltimateDebtor';
import {
...
describe('OpUltimateDebtor functions', () => {
  ...
  beforeEach(() => {
    ...
    testObject = createOpUltimateDebtor('TestName', identification, address);
  ...
  describe('explainOpUltimateDebtor', () => {
    it('should provide correct explanation for OpUltimateDebtor objects', () => {
      ...
      expect(explainOpUltimateDebtor(wrongObject)).toContain(
  ...
  describe('explainOpUltimateDebtorOrUndefined', () => {
    it('should provide correct explanation for OpUltimateDebtor or undefined', () => {
      ...
      expect(explainOpUltimateDebtorOrUndefined(wrongObject)).toEqual(
        'not OpUltimateDebtor or undefined',
      );
    });
  });
});
