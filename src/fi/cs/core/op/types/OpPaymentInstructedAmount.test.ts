import {
  ...
  explainOpPaymentInstructedAmountOrUndefined,
  isOpPaymentInstructedAmount,
  isOpPaymentInstructedAmountOrUndefined,
  OpPaymentInstructedAmount,
  parseOpPaymentInstructedAmount,
} from './OpPaymentInstructedAmount';
...
describe('OpPaymentInstructedAmount', () => {
  ...
  describe('createOpPaymentInstructedAmount', () => {
    it('should create a valid OpPaymentInstructedAmount', () => {
      const paymentAmount = createOpPaymentInstructedAmount(
        '100.00',
        'USD' as Currency,
      );
  ...
  describe('parseOpPaymentInstructedAmount', () => {
    it('should return OpPaymentInstructedAmount for a valid OpPaymentInstructedAmount', () => {
      expect(parseOpPaymentInstructedAmount(validPaymentAmount)).toEqual(
        validPaymentAmount,
      );
    });
    ...
    it('should return undefined for an invalid OpPaymentInstructedAmount', () => {
      expect(
        parseOpPaymentInstructedAmount(invalidPaymentAmount),
      ).toBeUndefined();
    });
  });
  ...
  describe('isOpPaymentInstructedAmountOrUndefined', () => {
    it('should return true for valid OpPaymentInstructedAmount', () => {
      expect(isOpPaymentInstructedAmountOrUndefined(validPaymentAmount)).toBe(
        true,
      );
    });
    ...
    it('should return false for invalid OpPaymentInstructedAmount', () => {
      expect(isOpPaymentInstructedAmountOrUndefined(invalidPaymentAmount)).toBe(
        false,
      );
    });
  });
  ...
  describe('explainOpPaymentInstructedAmountOrUndefined', () => {
    it('should return explanation for a valid OpPaymentInstructedAmount', () => {
      // replace 'OK' with what you actually expect
      expect(
        explainOpPaymentInstructedAmountOrUndefined(validPaymentAmount),
      ).toBe('OK');
    });
