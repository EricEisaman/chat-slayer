import {
  ...
  explainOpPaymentStatusOrUndefined,
  isOpPaymentStatus,
  isOpPaymentStatusOrUndefined,
  OpPaymentStatus,
  parseOpPaymentStatus,
  stringifyOpPaymentStatus,
} from './OpPaymentStatus';
...
describe('OpPaymentStatus', () => {
  ...
  describe('explainOpPaymentStatus', () => {
    it('should return expected explanation for valid and invalid statuses', () => {
      ...
      expect(explainOpPaymentStatus(invalidStatus)).toBe(
        'incorrect enum value "UNKNOWN" for OpPaymentStatus: Accepted values PROCESSING, PROCESSED',
      );
    });
  });
  ...
  describe('explainOpPaymentStatusOrUndefined', () => {
    it('should return expected explanation for valid, invalid, and undefined statuses', () => {
      ...
      // replace 'OK' with the actual expected explanation for invalid case
      expect(explainOpPaymentStatusOrUndefined(invalidStatus)).toBe(
        'not OpPaymentStatus or undefined',
      );
