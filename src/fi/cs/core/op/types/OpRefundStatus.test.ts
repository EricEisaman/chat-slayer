import {
  ...
  explainOpRefundStatusOrUndefined,
  isOpRefundStatus,
  isOpRefundStatusOrUndefined,
  OpRefundStatus,
  parseOpRefundStatus,
  stringifyOpRefundStatus,
} from './OpRefundStatus';
...
describe('OpRefundStatus functions', () => {
  ...
  describe('explainOpRefundStatus', () => {
    ...
    it('should explain invalid statuses correctly', () => {
      ...
      expect(explainOpRefundStatus(invalidValue)).toBe(
        `incorrect enum value "${invalidValue}" for RefundStatus: Accepted values PROCESSING, PROCESSED`,
      );
    });
  });
  ...
  describe('stringifyOpRefundStatus', () => {
    it('should stringify valid statuses correctly', () => {
      expect(stringifyOpRefundStatus(OpRefundStatus.PROCESSING)).toBe(
        'PROCESSING',
      );
    });

    it('should throw error for invalid statuses', () => {
      expect(() => stringifyOpRefundStatus('RANDOM_VALUE' as any)).toThrow(
  ...
  describe('parseOpRefundStatus', () => {
    ...
    it('should parse ignoring spaces and dashes', () => {
      expect(parseOpRefundStatus('PRO CES SING')).toBe(
        OpRefundStatus.PROCESSING,
      );
      expect(parseOpRefundStatus('PRO-CES-SING')).toBe(
        OpRefundStatus.PROCESSING,
      );
  ...
  describe('explainOpRefundStatusOrUndefined', () => {
    it('should explain valid statuses or undefined correctly', () => {
      expect(explainOpRefundStatusOrUndefined(OpRefundStatus.PROCESSING)).toBe(
        'OK',
      );
    ...
    it('should provide explanations for other invalid values', () => {
      expect(explainOpRefundStatusOrUndefined('RANDOM_VALUE')).toBe(
        'not RefundStatus or undefined',
      );
    });
  });
});
