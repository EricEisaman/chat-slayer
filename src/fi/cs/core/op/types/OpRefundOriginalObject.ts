...
export function isOpRefundOriginalObject(
  value: unknown,
): value is OpRefundOriginalObject {
  return (
...
export function explainOpRefundOriginalObject(value: unknown): string {
  return explain([
...
export function parseOpRefundOriginalObject(
  value: unknown,
): OpRefundOriginalObject | undefined {
  if (isOpRefundOriginalObject(value)) return value;
  return undefined;
}

export function isOpRefundOriginalObjectOrUndefined(
  value: unknown,
): value is OpRefundOriginalObject | undefined {
  return isUndefined(value) || isOpRefundOriginalObject(value);
}

export function explainOpRefundOriginalObjectOrUndefined(
  value: unknown,
): string {
  return isOpRefundOriginalObjectOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['OpRefundOriginalObject', 'undefined']));
}
