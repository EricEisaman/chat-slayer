...
describe('OpTransactionListDTO', () => {
  ...
  const mockTransactionList = createOpTransactionListDTO([
    mockTransaction,
    mockTransaction,
  ]);
  ...
  describe('explainOpTransactionListDTO', () => {
    it('provides explanation if a value is not OpTransactionListDTO', () => {
      ...
      expect(explainOpTransactionListDTO(invalidTransactionList)).toContain(
        'OpTransactionDTO',
      );
    });
  });
  ...
  describe('parseOpTransactionListDTO', () => {
    it('parses an OpTransactionListDTO or returns undefined', () => {
      expect(parseOpTransactionListDTO(mockTransactionList)).toEqual(
        mockTransactionList,
      );
  ...
  describe('isOpTransactionListDTOOrUndefined', () => {
    it('validates if a value is OpTransactionListDTO or undefined', () => {
      expect(
        isOpTransactionListDTOOrUndefined(mockTransactionList),
      ).toBeTruthy();
      expect(
        isOpTransactionListDTOOrUndefined(invalidTransactionList),
      ).toBeFalsy();
  ...
  describe('explainOpTransactionListDTOOrUndefined', () => {
    it('provides explanation if a value is not OpTransactionListDTO or undefined', () => {
      expect(
        explainOpTransactionListDTOOrUndefined(mockTransactionList),
      ).toEqual('OK');
      expect(
        explainOpTransactionListDTOOrUndefined(invalidTransactionList),
      ).toContain('not OpTransactionListDTO or undefined');
