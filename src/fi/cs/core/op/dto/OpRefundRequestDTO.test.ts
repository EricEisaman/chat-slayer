...
import {
  createOpRefundRequestDTO,
  explainOpRefundRequestDTO,
  explainOpRefundRequestDTOOrUndefined,
  isOpRefundRequestDTO,
  isOpRefundRequestDTOOrUndefined,
  OpRefundRequestDTO,
  parseOpRefundRequestDTO,
} from './OpRefundRequestDTO';
...
describe('OpRefundRequestDTO', () => {
  ...
  describe('explainOpRefundRequestDTO', () => {
    ...
    it('provides explanations for invalid properties', () => {
      ...
      expect(explainOpRefundRequestDTO(invalidDTO)).toContain(
        'property "amount"',
      );
    });
  });
  ...
  describe('explainOpRefundRequestDTOOrUndefined', () => {
    ...
    it('provides explanations for invalid properties', () => {
      const invalidDTO = {...validDTO, amount: 100}; // made amount a number
      expect(explainOpRefundRequestDTOOrUndefined(invalidDTO)).toContain(
        'not OpPaymentRefundRequestDTO or undefined',
      );
    });
  });
});
