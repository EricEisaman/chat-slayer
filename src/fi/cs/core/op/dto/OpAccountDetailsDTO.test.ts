import {
  createOpAccountDetailsDTO,
  explainOpAccountDetailsDTO,
  explainOpAccountDetailsDTOOrUndefined,
  isOpAccountDetailsDTO,
  isOpAccountDetailsDTOOrUndefined,
  parseOpAccountDetailsDTO,
} from './OpAccountDetailsDTO';
...
describe('OpAccountDetailsDTO functions', () => {
  ...
  describe('explainOpAccountDetailsDTO', () => {
    ...
    it('should return explanation for an invalid OpAccountDetailsDTO', () => {
      expect(explainOpAccountDetailsDTO(invalidOpAccountDetailsDTO)).toContain(
  ...
  describe('parseOpAccountDetailsDTO', () => {
    it('should return the given value if it is a valid OpAccountDetailsDTO', () => {
      expect(parseOpAccountDetailsDTO(validOpAccountDetailsDTO)).toEqual(
    ...
    it('should return undefined if the given value is not a valid OpAccountDetailsDTO', () => {
      expect(
        parseOpAccountDetailsDTO(invalidOpAccountDetailsDTO),
      ).toBeUndefined();
    });
  });
  ...
  describe('isOpAccountDetailsDTOOrUndefined', () => {
    it('should return true for a valid OpAccountDetailsDTO', () => {
      expect(isOpAccountDetailsDTOOrUndefined(validOpAccountDetailsDTO)).toBe(
        true,
      );
    });
    ...
    it('should return false for an invalid OpAccountDetailsDTO', () => {
      expect(isOpAccountDetailsDTOOrUndefined(invalidOpAccountDetailsDTO)).toBe(
        false,
      );
    });
  });
  ...
  describe('explainOpAccountDetailsDTOOrUndefined', () => {
    it('should return OK for a valid OpAccountDetailsDTO', () => {
      expect(
        explainOpAccountDetailsDTOOrUndefined(validOpAccountDetailsDTO),
      ).toBe('OK');
    });
    ...
    it('should return explanation for an invalid OpAccountDetailsDTO', () => {
      expect(
        explainOpAccountDetailsDTOOrUndefined(invalidOpAccountDetailsDTO),
      ).toContain('not OpAccountDetailsDTO or undefined');
    });
  });
});
