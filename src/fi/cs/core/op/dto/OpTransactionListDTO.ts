...
export function createOpTransactionListDTO(
  ...
  return map(list, (item: OpTransactionDTO): OpTransactionDTO => item);
}

export function isOpTransactionListDTO(
  value: unknown,
): value is OpTransactionListDTO {
  return isArrayOf<OpTransactionDTO>(value, isOpTransactionDTO);
}

export function explainOpTransactionListDTO(value: unknown): string {
  return explainArrayOf<OpTransactionDTO>(
    'OpTransactionDTO',
    explainOpTransactionDTO,
    value,
    isOpTransactionDTO,
...
export function parseOpTransactionListDTO(
  value: unknown,
...
export function isOpTransactionListDTOOrUndefined(
  value: unknown,
): value is OpTransactionListDTO | undefined {
...
export function explainOpTransactionListDTOOrUndefined(value: unknown): string {
  return isOpTransactionListDTOOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['OpTransactionListDTO', 'undefined']));
}
