...
describe('OpPaymentResponseDTO', () => {
  ...
  describe('explainOpPaymentResponseDTO', () => {
    ...
    it('explains the problem for invalid DTO', () => {
      ...
      expect(explainOpPaymentResponseDTO(invalidDto)).toContain(
        'property "amount" not string',
      );
    });
  });
  ...
  describe('explainOpPaymentResponseDTOOrUndefined', () => {
    ...
    it('explains the problem for invalid DTO', () => {
      ...
      expect(explainOpPaymentResponseDTOOrUndefined(invalidDto)).toContain(
        'not OpPaymentResponseDTO or undefined',
      );
    });
  });
});
