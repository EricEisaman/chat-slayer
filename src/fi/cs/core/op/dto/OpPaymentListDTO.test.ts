...
import {
  createOpPaymentListDTO,
  explainOpPaymentListDTO,
  explainOpPaymentListDTOOrUndefined,
  isOpPaymentListDTO,
  isOpPaymentListDTOOrUndefined,
  parseOpPaymentListDTO,
} from './OpPaymentListDTO';
...
const MOCK_PAYMENT_LIST: readonly OpPaymentResponseDTO[] = [
...
describe('OpPaymentListDTO functions', () => {
  ...
  describe('parseOpPaymentListDTO', () => {
    it('should parse OpPaymentListDTO correctly', () => {
      expect(parseOpPaymentListDTO(MOCK_PAYMENT_LIST)).toEqual(
        MOCK_PAYMENT_LIST,
      );
  ...
  describe('explainOpPaymentListDTOOrUndefined', () => {
    it('should provide correct explanation for OpPaymentListDTO or undefined', () => {
      expect(explainOpPaymentListDTOOrUndefined(MOCK_PAYMENT_LIST)).toEqual(
        'OK',
      );
      expect(explainOpPaymentListDTOOrUndefined(undefined)).toEqual('OK');
      expect(explainOpPaymentListDTOOrUndefined({})).toEqual(
        'not OpPaymentListDTO or undefined',
      );
    });
  });
});
