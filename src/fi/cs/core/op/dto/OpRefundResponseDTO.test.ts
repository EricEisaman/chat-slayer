...
import {
  createOpRefundResponseDTO,
  explainOpRefundResponseDTO,
  explainOpRefundResponseDTOOrUndefined,
  isOpRefundResponseDTO,
  isOpRefundResponseDTOOrUndefined,
  OpRefundResponseDTO,
  parseOpRefundResponseDTO,
} from './OpRefundResponseDTO';
...
describe('OpRefundResponseDTO functions', () => {
  ...
  describe('createOpRefundResponseDTO', () => {
    it('should create a valid object', () => {
      const result = createOpRefundResponseDTO(
        validObject.original,
        validObject.refund,
      );
  ...
  describe('explainOpRefundResponseDTO', () => {
    ...
    it('should provide explanations for invalid properties', () => {
      const invalidObject = {...validObject, original: null};
      expect(explainOpRefundResponseDTO(invalidObject)).toContain(
        'property "original"',
      );
    });
  });
  ...
  describe('explainOpRefundResponseDTOOrUndefined', () => {
    it('should explain a valid object correctly', () => {
      expect(explainOpRefundResponseDTOOrUndefined(validObject)).toContain(
        'OK',
      );
    });
    ...
    it('should provide explanations for invalid properties', () => {
      const invalidObject = {...validObject, refund: null};
      expect(explainOpRefundResponseDTOOrUndefined(invalidObject)).toContain(
        'OpRefundResponseDTO',
      );
    });
  });
