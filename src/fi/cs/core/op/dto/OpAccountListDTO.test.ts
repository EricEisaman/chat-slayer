...
describe('OpAccountListDTO', () => {
  ...
  const validOpAccountListDTO: OpAccountListDTO = [
    validOpAccountDTO,
    validOpAccountDTO,
  ];
  ...
  describe('createOpAccountListDTO', () => {
    it('should create a valid OpAccountListDTO object', () => {
      expect(
        createOpAccountListDTO([validOpAccountDTO, validOpAccountDTO]),
      ).toEqual(validOpAccountListDTO);
    });
  });
  ...
  describe('explainOpAccountListDTO', () => {
    ...
    it('should return explanation for an invalid OpAccountListDTO', () => {
      expect(explainOpAccountListDTO(invalidOpAccountListDTO)).toContain(
        'OpAccountDTO',
      );
    });
  });
  ...
  describe('parseOpAccountListDTO', () => {
    it('should return valid OpAccountListDTO object for a valid input', () => {
      expect(parseOpAccountListDTO(validOpAccountListDTO)).toEqual(
        validOpAccountListDTO,
      );
    });
  ...
  describe('isOpAccountListDTOOrUndefined', () => {
    ...
    it('should return false for an invalid OpAccountListDTO', () => {
      expect(isOpAccountListDTOOrUndefined(invalidOpAccountListDTO)).toBe(
        false,
      );
    });
  });
  ...
  describe('explainOpAccountListDTOOrUndefined', () => {
    it('should return OK for a valid OpAccountListDTO', () => {
      expect(explainOpAccountListDTOOrUndefined(validOpAccountListDTO)).toBe(
        'OK',
      );
    });
    ...
    it('should return explanation for an invalid OpAccountListDTO', () => {
      expect(
        explainOpAccountListDTOOrUndefined(invalidOpAccountListDTO),
      ).toContain('OpAccountListDTO');
    });
  });
});
