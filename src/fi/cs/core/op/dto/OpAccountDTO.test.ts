import {
  ...
  explainOpAccountDTO,
  parseOpAccountDTO,
  isOpAccountDTOOrUndefined,
  explainOpAccountDTOOrUndefined,
} from './OpAccountDTO';
...
describe('OpAccountDTO', () => {
  ...
  describe('explainOpAccountDTO', () => {
    ...
    it('should return explanation for an invalid OpAccountDTO', () => {
      expect(explainOpAccountDTO(invalidOpAccountDTO)).toContain(
        'property "bic"',
      );
    });
  });
  ...
  describe('explainOpAccountDTOOrUndefined', () => {
    ...
    it('should return explanation for an invalid OpAccountDTO', () => {
      expect(explainOpAccountDTOOrUndefined(invalidOpAccountDTO)).toContain(
        'not OpAccountDTO or undefined',
      );
    });
  });
});
