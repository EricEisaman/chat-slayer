...
import {
  ...
  OP_PRODUCTION_URL,
  OP_SEPA_INSTANT_PAYMENT_STATUS_PATH,
} from './op-constants';
...
export class OpPaymentClientImpl implements OpPaymentClient, OpAuthClient {
  ...
  public static create(
    ...
    return new OpPaymentClientImpl(client, auth, signer, url);
  }
  ...
  public async createPayment(
    paymentRequestDto: OpPaymentRequestDTO,
  ): Promise<OpPaymentResponseDTO> {
    return await OpRequestUtils.postSignedRequest<
      OpPaymentRequestDTO,
      OpPaymentResponseDTO
    >(
      this._client,
