 ...
 *
 */
export interface FiCsComJokerDomainManagementAPI {
  /**
   *
   */
  hasSession(): boolean;
   ...
   * @param domain
   */
  queryWhoisByDomain(domain: string): Promise<JokerComApiWhoisDTO>;
   ...
   */
  queryWhoisByContact(contact: string): Promise<JokerComApiWhoisContactDTO>;
   ...
   * @param host
   */
  queryWhoisByHost(host: string): Promise<JokerComApiWhoisDTO>;
   ...
   */
  grantsList(domain: string, showKey: string): Promise<string>;
