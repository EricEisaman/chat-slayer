...
export function RequestParam(
  ...
  function _param(
    ...
    const requestController = _getRequestController(
      target,
      propertyKey,
      paramIndex,
    );
  ...
  if (
    isString(arg1) &&
    arg3 === undefined &&
    isRequestParamValueTypeOrUndefined(arg2)
  ) {
    const queryParam = arg1;
    const paramType: RequestParamValueType =
      arg2 ?? RequestParamValueType.STRING;
    return (
      target: any | Function,
      propertyKey?: string,
      paramIndex?: number,
