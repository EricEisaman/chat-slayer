...
import {
  ...
  isRequestQueryParamObject,
} from './RequestQueryParamObject';
import {
  RequestBodyParamObject,
  isRequestBodyParamObject,
} from './RequestBodyParamObject';
import {
  RequestHeaderParamObject,
  isRequestHeaderParamObject,
} from './RequestHeaderParamObject';
import {
  RequestHeaderMapParamObject,
  isRequestHeaderMapParamObject,
} from './RequestHeaderMapParamObject';
import {
  RequestPathVariableParamObject,
  isRequestPathVariableParamObject,
} from './RequestPathVariableParamObject';
import {
  RequestPathVariableMapParamObject,
  isRequestPathVariableMapParamObject,
} from './RequestPathVariableMapParamObject';
import {
  RequestModelAttributeParamObject,
  isRequestModelAttributeParamObject,
} from './RequestModelAttributeParamObject';
...
export function isRequestParamObject(
  value: unknown,
): value is RequestParamObject {
  return (
