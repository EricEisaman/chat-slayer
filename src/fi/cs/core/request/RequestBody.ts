...
import {
  getOpenApiTypeStringFromRequestParamValueType,
  RequestParamValueType,
} from './types/RequestParamValueType';
...
export function RequestBody(
  ...
  if (
      ...
      propertyKey,
      {
        requestBody: {
          ...
          content: {
            'application/json': {
              schema: {
                type: getOpenApiTypeStringFromRequestParamValueType(
                  RequestParamValueType.JSON,
                ),
              },
            },
    ...
    LOG.warn(
      'body: Unrecognized configuration: ',
      '; target=',
      target,
      '; propertyKey=',
      propertyKey,
