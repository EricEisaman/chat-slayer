 ...
 * @nosideeffects
 */
export function explainNumber(value: unknown): string {
 ...
 * @nosideeffects
 */
export function explainNumberOrUndefined(value: unknown): string {
  return isNumberOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['number', 'undefined']));
}
 ...
 * @nosideeffects
 */
export function isNumberOrNullOrUndefined(
  value: unknown,
 ...
 * @nosideeffects
 */
export function explainNumberOrNullOrUndefined(value: unknown): string {
  return isNumberOrNullOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['number', 'null', 'undefined']));
}
 ...
 * @nosideeffects
 */
export function explainNumberOrNull(value: unknown): string {
  return isNumberOrNull(value)
    ? explainOk()
    : explainNot(explainOr(['number', 'null']));
}
...
export function parseInteger(value: unknown): number | undefined {
  ...
  if (_isString(value)) {
    ...
    const parsedValue = toSafeInteger(trimmed);
    return isSafeInteger(parsedValue) && parsedValue.toFixed(0) === trimmed
      ? parsedValue
      : undefined;
  }
 ...
 * @nosideeffects
 */
export function explainInteger(value: unknown): string {
 ...
 * @nosideeffects
 */
export function isIntegerOrUndefined(
  value: unknown,
): value is number | undefined {
 ...
 * @nosideeffects
 */
export function explainIntegerOrUndefined(value: unknown): string {
  return isInteger(value)
    ? explainOk()
    : explainNot(explainOr(['integer', 'undefined']));
}
