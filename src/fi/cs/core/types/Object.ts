 ...
 * @nosideeffects
 */
export function isObject(value: unknown): value is {[P in string]: any} {
 ...
 * @nosideeffects
 */
export function explainObject(value: unknown): string {
 ...
 * @nosideeffects
 */
export function isObjectOrUndefined(
  value: unknown,
 ...
 * @nosideeffects
 */
export function explainObjectOrUndefined(value: unknown): string {
  return isObjectOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['object', 'undefined']));
}
