...
describe('Currency', () => {
  ...
  describe('explainCurrency', () => {
    ...
    it('should return explanation for invalid currencies', () => {
      expect(explainCurrency('XYZ')).toContain(
        'incorrect enum value "XYZ" for Currency: Accepted values EUR, USD, GBP',
      );
      expect(explainCurrency(null)).toContain(
        'incorrect enum value "null" for Currency: Accepted values EUR, USD, GBP',
      );
      expect(explainCurrency(undefined)).toContain(
        'incorrect enum value "undefined" for Currency: Accepted values EUR, USD, GBP',
      );
    });
  });
