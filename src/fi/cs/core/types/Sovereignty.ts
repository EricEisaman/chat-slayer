...
export function parseSovereignty(value: unknown): Sovereignty | undefined {
  return parseEnum(Sovereignty, value, true, true) as Sovereignty | undefined;
}

export function isSovereigntyOrUndefined(
  value: unknown,
): value is Sovereignty | undefined {
  return isUndefined(value) || isSovereignty(value);
}

export function explainSovereigntyOrUndefined(value: unknown): string {
  return isSovereigntyOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['Sovereignty', 'undefined']));
}
