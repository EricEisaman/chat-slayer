...
export class ChildProcessError extends Error {
  ...
  public constructor(
    ...
    super(
      ChildProcessError.stringifyExceptionArguments(
        name,
        args,
        status,
        signal,
  ...
  public toJSON(): ReadonlyJsonObject {
    const {name, args, status, signal, message} = this;
    return {
      name,
      args,
      status,
  ...
  public static create(
    ...
    return new ChildProcessError(name, args, status, signal, message);
  }
}
...
export function createChildProcessError(
  ...
  return ChildProcessError.create(name, args, status, signal, message);
}

export function isChildProcessError(
  value: unknown,
): value is ChildProcessError {
  return !!value && value instanceof ChildProcessError;
}
