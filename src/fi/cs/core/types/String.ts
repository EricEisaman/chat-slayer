 ...
 * @nosideeffects
 */
export function explainString(value: unknown): string {
 ...
 * @nosideeffects
 */
export function explainStringOrFalse(value: unknown): string {
  return isStringOrFalse(value)
    ? explainOk()
    : explainNot(explainOr(['string', 'false']));
}
 ...
 * @nosideeffects
 */
export function explainNonEmptyString(value: unknown): string {
 ...
 * @nosideeffects
 */
export function explainStringOrUndefined(value: unknown): string {
  return isStringOrUndefined(value)
    ? explainOk()
 ...
 * @nosideeffects
 */
export function explainStringOrNullOrUndefined(value: unknown): string {
  return isStringOrNullOrUndefined(value)
    ? explainOk()
 ...
 * @nosideeffects
 */
export function isStringOrNumberOrNullOrUndefined(
  value: unknown,
): value is string | undefined | null {
  return (
    isNumber(value) || isNull(value) || isUndefined(value) || isString(value)
  );
}
 ...
 * @nosideeffects
 */
export function explainStringOrNumberOrNullOrUndefined(value: unknown): string {
  return isStringOrNumberOrNullOrUndefined(value)
    ? explainOk()
    : explainNot(explainOr(['string', 'number', 'null', 'undefined']));
}
 ...
 * @nosideeffects
 */
export function explainStringOrNull(value: unknown): string {
  return isStringOrNull(value)
    ? explainOk()
    : explainNot(explainOr(['string', 'null']));
}
 ...
 * @nosideeffects
 */
export function explainStringOrSymbol(value: unknown): string {
...
export function prefixLines(value: string, prefix: string): string {
  return `${prefix}${replaceAll(value, '\n', `\n${prefix}`)}`;
}
