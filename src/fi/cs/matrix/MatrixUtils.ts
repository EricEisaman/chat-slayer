...
} from './types/event/roomJoinRules/RoomJoinRulesStateEventDTO';
...
} from './types/event/roomHistoryVisibility/RoomHistoryVisibilityStateEventDTO';
...
} from './types/event/roomGuestAccess/RoomGuestAccessStateEventDTO';
...
import {
  createRoomMemberStateEventDTO,
  RoomMemberStateEventDTO,
} from './types/event/roomMember/RoomMemberStateEventDTO';
...
export class MatrixUtils {
  public static getUserId(username: string, hostname: string): MatrixUserId {
    return `@${username}:${hostname}`;
  }

  public static getRoomAlias(alias: string, hostname: string): MatrixRoomAlias {
    return `#${alias}:${hostname}`;
  }

  public static getRoomId(id: string, hostname: string): MatrixRoomId {
    return `!${id}:${hostname}`;
  }
  ...
  public static createRoomJoinRulesEventDTO(
    ...
    return createRoomJoinRulesStateEventDTO(
      createRoomJoinRulesStateContentDTO(joinRule, [
  ...
  public static createRoomHistoryVisibilityEventDTO(
    ...
    return createRoomHistoryVisibilityStateEventDTO(
      createRoomHistoryVisibilityStateContentDTO(visibility),
    );
  }
    ...
    switch (preset) {
      case MatrixCreateRoomPreset.PRIVATE_CHAT:
        return [
          ...
          this.createRoomHistoryVisibilityEventDTO(
