...
export function isRoomMembershipType(
  value: unknown,
): value is RoomMembershipType {
  switch (value) {
...
export function parseRoomMembershipType(
  value: unknown,
): RoomMembershipType | undefined {
  switch (`${value}`.toLowerCase()) {
    case 'm.room_membership':
    case 'room_membership':
      return RoomMembershipType.M_ROOM_MEMBERSHIP;
