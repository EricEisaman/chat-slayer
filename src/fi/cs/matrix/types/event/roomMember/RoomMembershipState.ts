...
export function isRoomMembershipState(
  value: unknown,
): value is RoomMembershipState {
  switch (value) {
...
export function stringifyRoomMembershipState(
  value: RoomMembershipState,
): string {
  switch (value) {
    case RoomMembershipState.INVITE:
      return 'INVITE';
...
export function parseRoomMembershipState(
  value: unknown,
): RoomMembershipState | undefined {
