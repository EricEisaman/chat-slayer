...
export function isMatrixHistoryVisibility(
  value: unknown,
): value is MatrixHistoryVisibility {
  switch (value) {
...
export function stringifyMatrixHistoryVisibility(
...
export function parseMatrixHistoryVisibility(
  value: unknown,
): MatrixHistoryVisibility | undefined {
  if (value === undefined) return undefined;
  switch (`${value}`.toUpperCase()) {
    case 'INVITED':
      return MatrixHistoryVisibility.INVITED;
    case 'JOINED':
      return MatrixHistoryVisibility.JOINED;
    case 'SHARED':
      return MatrixHistoryVisibility.SHARED;
    case 'WORLD_READABLE':
