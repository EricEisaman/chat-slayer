...
export function isSimpleMatrixClientState(
  value: unknown,
): value is SimpleMatrixClientState {
  switch (value) {
...
export function stringifySimpleMatrixClientState(
  value: SimpleMatrixClientState,
): string {
  switch (value) {
    case SimpleMatrixClientState.UNAUTHENTICATED:
    ...
    case SimpleMatrixClientState.AUTHENTICATED_AND_STARTING:
      return 'AUTHENTICATED_AND_STARTING';
    case SimpleMatrixClientState.AUTHENTICATED_AND_RESTARTING:
      return 'AUTHENTICATED_AND_RESTARTING';
    case SimpleMatrixClientState.AUTHENTICATED_AND_STARTED:
      return 'AUTHENTICATED_AND_STARTED';
    case SimpleMatrixClientState.AUTHENTICATED_AND_SYNCING:
      return 'AUTHENTICATED_AND_SYNCING';
  }
  throw new TypeError(`Unsupported SimpleMatrixClientState value: ${value}`);
}

export function parseSimpleMatrixClientState(
  value: unknown,
): SimpleMatrixClientState | undefined {
  switch (`${value}`.toUpperCase()) {
    case 'UNAUTHENTICATED':
      return SimpleMatrixClientState.UNAUTHENTICATED;
    case 'AUTHENTICATING':
      return SimpleMatrixClientState.AUTHENTICATING;
    case 'AUTHENTICATED':
      return SimpleMatrixClientState.AUTHENTICATED;
    case 'AUTHENTICATED_AND_STARTING':
      return SimpleMatrixClientState.AUTHENTICATED_AND_STARTING;
    case 'AUTHENTICATED_AND_RESTARTING':
      return SimpleMatrixClientState.AUTHENTICATED_AND_RESTARTING;
    case 'AUTHENTICATED_AND_STARTED':
      return SimpleMatrixClientState.AUTHENTICATED_AND_STARTED;
    case 'AUTHENTICATED_AND_SYNCING':
      return SimpleMatrixClientState.AUTHENTICATED_AND_SYNCING;
