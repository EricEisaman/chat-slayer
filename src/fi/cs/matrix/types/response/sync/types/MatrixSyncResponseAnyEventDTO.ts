...
export function isMatrixSyncResponseAnyEventDTO(
  value: unknown,
): value is MatrixSyncResponseAnyEventDTO {
  return (
...
export function stringifyMatrixSyncResponseAnyEventDTO(
  value: MatrixSyncResponseAnyEventDTO,
): string {
  return `MatrixSyncResponseAnyEventDTO(${value})`;
}

export function parseMatrixSyncResponseAnyEventDTO(
  value: unknown,
): MatrixSyncResponseAnyEventDTO | undefined {
