...
export function isMatrixErrorCode(value: unknown): value is MatrixErrorCode {
  switch (value) {
...
export function parseMatrixErrorCode(
  value: unknown,
  ...
  switch (value) {
    ...
    case 'M_USER_IN_USE':
      return MatrixErrorCode.M_USER_IN_USE;
    case 'M_INVALID_USERNAME':
      return MatrixErrorCode.M_INVALID_USERNAME;
    case 'M_EXCLUSIVE':
