...
export class MatrixRepositoryInitializer<
...
> implements SimpleRepositoryInitializer<T> {
  ...
  public async initializeRepository(
    ...
    if (!(client instanceof SimpleMatrixClient))
      throw new TypeError(
        'MatrixRepositoryInitializer.initializeRepository: Shared client not defined or not SimpleMatrixClient',
      );
