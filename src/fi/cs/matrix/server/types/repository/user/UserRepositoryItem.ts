...
import {
  createStoredUserRepositoryItem,
  StoredUserRepositoryItem,
} from './StoredUserRepositoryItem';
...
export function isUserRepositoryItem(
  value: unknown,
): value is UserRepositoryItem {
  return (
...
export function parseUserRepositoryItem(
  ...
  return createUserRepositoryItem(
    id,
    createUser(id, target.username, target.password, email),
